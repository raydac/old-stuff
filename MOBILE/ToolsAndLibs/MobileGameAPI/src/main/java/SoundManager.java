...
public class SoundManager
{
    ...
    public static final int SOUND_BASKET = 3;
    public static final int SOUND_BUNCH = 4;
    public static final int SOUND_PLAYERKILLED = 5;
    public static final int SOUND_PLAYERWIN = 6;

    private static final int SOUNDS_NUMBER = 7;
    ...
    {
        stopAllSound();
        for(int li=0;li<PLAYERS_NUMBER;li++) ap_Players[li] = null;
    }

...
public class GIFFont extends AbstractFont
{
    ...
    public static final String CHARSET = "\n 0123456789:.,!?+-/\'\"()ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ";
    ...
    public void drawString(Graphics _g, int _x, int _y, String _string)
    {
        ...
        for(int li=0;li<i_len;li++)
        {
            ...
            if (i_index<0)
            {
                // Ğèñóåì êâàäğàò ñ êğåñòèêîì, â çíàê ÷òî ñèìâîëà íåò
    ...
    public boolean loadFontFromFile(File _file) throws IOException
    {
        ...
        // Âû÷èñëÿåì èíòåğâàë ìåæäó ñèìâîëàìè

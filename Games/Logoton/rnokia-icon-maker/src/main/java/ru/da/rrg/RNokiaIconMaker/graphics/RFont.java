...
public class RFont
{
	...
	protected boolean checkzero(int c)
	{
		c = c & 0x00FFFFFF;
		if (c!=ColorEtaloner.black) return false; else return true;
	}	
	...
	public RFont(Applet appl,String fontname,String fontfile) throws IOException 
	{
		...
		Image fntimg = Utilities.loadImageResource(owner,"fonts/"+fontfile);
	...
	public int drawSymbol(Graphics g,int cde,int x,int y)
	{

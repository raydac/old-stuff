...
//   if(canvas.gameStatus!=canvas.titleStatus)
   ListItem.addCommand(cBack);
   ListItem.setCommandListener(this);
   return ListItem;
 }
...
boolean JustStarted = true;
 ...
 private static final byte Loading = 63;
 private static final byte EndGameAsk = 64;
 private static final byte EndGameCMD = 65;
 private static final byte LoadSaveTitle = 66;
}

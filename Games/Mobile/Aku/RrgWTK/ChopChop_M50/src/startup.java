...
//if(saMSG.length<60)System.out.println("Not enough quantity of necessary resources (need:66, really loaded:"+saMSG.length+")");
 ...
 private static byte CreditsCMD = (byte)55;
 private static byte NewStage = (byte)56;
 private static byte ResumeGame = (byte)57;
 private static byte NewGameTitle = (byte)58;
 private static byte DeleTitle = (byte)59;
 private static byte ClearAllTitle = (byte)60;
 private static byte GameNotSaved = (byte)61;
 private static byte RMSMaxRecordsLimit = (byte)62;
 private static byte Loading = (byte)63;
 private static byte EndGameAsk = (byte)64;
 private static byte EndGameCMD = (byte)65;
 private static byte LoadSaveTitle = (byte)66;
}

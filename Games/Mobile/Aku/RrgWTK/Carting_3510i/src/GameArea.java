...
//OP_DST,7
	...
	//baseX+restxt.RoadBorder[CurrentLevel]+loc.getPlayerX(),baseY+loc.getPlayerY(),Graphics.TOP|Graphics.LEFT);
        ...
        gBuffer.drawImage(roadImage,baseX,baseY,Graphics.TOP|Graphics.LEFT);
	...
	// drawin' the left attempts
	 for (int i=0;i<loc.getAttemptNumber();i++){
           gBuffer.drawImage(AttemptsImage,baseX+levelImage.getWidth()-(i+1)*(AttemptsImage.getWidth()+2)-10,baseY+levelImage.getHeight()-AttemptsImage.getHeight()-2,Graphics.TOP|Graphics.LEFT);
	 }

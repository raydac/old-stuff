...
public class LanguageBlock
{
     ...
     */
    public void setLanguage(int _index,com.GameArea _loadListener) throws IOException
    {
     ...
     * @throws IOException
     */
    public LanguageBlock(String _language_list,int _language_id,com.GameArea _loadListener) throws IOException
    {

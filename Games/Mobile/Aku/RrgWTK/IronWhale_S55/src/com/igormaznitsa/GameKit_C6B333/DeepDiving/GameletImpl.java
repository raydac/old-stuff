...
//-------------------------------------------------------------------------------------------------------------
    public static final int I8_SEASURFACE_OFFSET = 0x2500; // sea-surface offset
    public static final int I_GROUND_OFFSET = 18;          // ground lift , it lift ground onto these points

    private static final int I8_HIGHCHOPPERBORDER = 0x300; // copter's tunnel
    private static final int I8_LOWCHOPPERBORDER = 0x1c00; //

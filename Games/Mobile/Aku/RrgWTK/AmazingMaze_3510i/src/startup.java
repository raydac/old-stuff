...
//	  case subVIBRA    : sVibra(); break;
	  ...
	  case subRESTART  : AreYouSure(saMSG[EndGameAsk]); break;
	   ...
	   showSubMenu(menuState, subMenu);
          ...
          if (cmd == cYes){
		    ...
		    case subCLEARALL: {
				      ...
				      break;
		    case subRESTART : canvas.restart(); showSubMenu(-1,-1); break;
...
*/
		   ...
		   case 2: showSubMenu(menuState,subRESTART);break;
		   case 3: showHelp();break;
		   case 4: showSubMenu(sGAMEOPTIONS,-1);break;
		   case 5: showSubMenu(menuState,subENDGAME);break;
                 }
                } else

...
{
    // -----------------------------------------------------------------------------
    private int state = -1;     // Object state
    private int type  = -1;     // Object type
    ...
    public static final int DIR_DOWNRIGHT = 6;
    public static final int DIR_UPLEFT = 7;
    ...
    {
        int ret[] = new int[getArrayLength()];
        ret[0] = screenWIDTH;
        ret[1] = screenHEIGHT;
        ret[2] = X;
        ret[3] = Y;
    ...
    */
    public boolean checkCollision(int objX, int objY, int objWidth, int objHeight)
    {
         ...
         return !((X+WIDTH) < objX || X > (objX+objWidth)  || (Y+HEIGHT) < objY || Y >(objY+objHeight));
/*
        boolean ret = false;
        boolean yok = false;
        boolean xok = false;

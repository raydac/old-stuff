...
{
    public static final int ROAD_WIDTH = 81;
    public static final int ROAD_HEIGHT = 80;
    ...
    public static final int PLAYER_CELL_WIDTH = 10;
    public static final int PLAYER_CELL_HEIGHT = 15;

    public static final int OBSTACLE_CELL_WIDTH = 10;
    public static final int OBSTACLE_CELL_HEIGHT = 15;

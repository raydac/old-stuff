...
//if(saMSG.length<60)System.out.println("Not enough quantity of necessary resources (need:66, really loaded:"+saMSG.length+")");
 ...
 private static byte SaveTitle = 0;
 private static byte LevelName1 = 1;
 private static byte LevelName2 = 2;
 private static byte LevelName3 = 3;
 private static byte AutoSaveName = 4;
 private static byte DefSaveName = 5;
 private static byte HighContent = 6;
 private static byte YourScore = 7;
 private static byte OffCMD = 8;
 private static byte NewGameCMD = 9;
 private static byte GameNotLoaded = 10;
 private static byte HelpCMD = 11;
 private static byte CancelCMD = 12;
 private static byte RMSEmptyList = 13;
 private static byte HighCMD = 14;
 private static byte YesCMD = 15;
 private static byte Language = 16;
 private static byte Reverse = 17;
 private static byte PlayerNameTitle = 18;
 private static byte DefPlayerName = 19;
 private static byte GameSaved = 20;
 private static byte LoadSaveCMD = 21;
 private static byte RMSOStreamFail = 22;
 private static byte NoRecordsAvailableContent = 23;
 private static byte DeleAsk = 24;
 private static byte HelpTitle = 25;
 private static byte LoadTitle = 26;
 private static byte MainMenuTitle = 27;
 private static byte RMSHasNoRoom = 28;
 private static byte HelpContent = 29;
 private static byte RMSReadingFail = 30;
 private static byte ExitGameAsk = 31;
 private static byte OptionCMD = 32;
 private static byte ClearAllAsk = 33;
 private static byte GameMenuTitle = 34;
 private static byte CreditsImage = 35;
 private static byte AcceptCMD = 36;
 private static byte CreditsTitle = 37;
 private static byte RMSBaseNotOpen = 38;
 private static byte Light = 39;
 private static byte NoCMD = 40;
 private static byte OnCMD = 41;
 private static byte Sound = 42;
 private static byte ExitCMD = 43;
 private static byte AreYouSureTitle = 44;
 private static byte CreditsContent = 45;
 private static byte RMSCantDelete = 46;
 private static byte PlayerNameAsk = 47;
 private static byte RMSCantOpen = 48;
 private static byte SpecialSection = 49;
 private static byte OptionTitle = 50;
 private static byte HighTitle = 51;
 private static byte BackCMD = 52;
 private static byte RewriteAsk = 53;
 private static byte NewRecordContent = 54;
 private static byte CreditsCMD = 55;
 private static byte NewStage = 56;
 private static byte ResumeGame = 57;
 private static byte NewGameTitle = 58;
 private static byte DeleTitle = 59;
 private static byte ClearAllTitle = 60;
 private static byte GameNotSaved = 61;
 private static byte RMSMaxRecordsLimit = 62;
 private static byte Vibration = 63;
 private static byte Loading = 64;
 private static byte EndGameAsk = 65;
 private static byte EndGameCMD = 66;
 private static byte LoadSaveTitle = 67;

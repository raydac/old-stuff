...
//    Displayable prevDisplay;
    ...
    private final static int _maxcharinname = 12;
 ...
 public void startme(){
  ...
  public void run(){
    if(JustStarted){
	      ...
	      try {
                canvas.start(67+62);
                GDS = new GameDataStorage("CHOP"/*canvas.client_sb.getGameID()*/,_maxsaveddata,_maxcharinname,_maxsavedgames,_maxrecoedsintoplist);

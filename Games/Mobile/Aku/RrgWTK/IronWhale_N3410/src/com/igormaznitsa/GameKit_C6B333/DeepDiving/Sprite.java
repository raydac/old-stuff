...
//====================================================================
    ...
    public static final short [] ai_AnimationArray = new short[]
    {
        ...
        //SPRITE_SUBMARINE
        20,10,2,3,16,7,2,1,ANIMATION_CYCLIC,0x500,(short)0xFFC0,
        //SPRITE_SUFRACESHIP
        20,10,0,0,20,10,2,1,ANIMATION_CYCLIC,0x800,(short)0xFFC0,
        //SPRITE_CHOPPERLEFT
        12,07,0,0,12,07,4,1,ANIMATION_CYCLIC,3,(short)0xFFC0,
        //SPRITE_ICEBERG
        20,15,0,0,20,15,1,1,ANIMATION_CYCLIC,0x600,(short)0xFFC0,
        //SPRITE_MINE
        8, 8, 0, 0, 8,8,1,1,ANIMATION_CYCLIC,0x100,(short)0xF000,
        //SPRITE_SURFACEBOMB
        5,6,0,0,5,6,1,1,ANIMATION_CYCLIC,0x400,(short)0xF800,
        //SPRITE_UNDERWATERBOMB
        5,5,0,0,5,5,1,1,ANIMATION_CYCLIC,3,(short)0xF800,
        //SPRITE_TORPEDO
        8,7,0,0,8,7,1,1,ANIMATION_CYCLIC,3,(short)0xF800,
        //SPRITE_ROCKET
        7,8,0,0,7,8,1,1,ANIMATION_CYCLIC,3,(short)0xFFC0,
        //SPRITE_AIRCRAFTCARRIER
        24,14,0,0,24,14,2,1,ANIMATION_CYCLIC,0xb00,(short)0xFFC0,
        //SPRITE_EXPLOSIONUNDERWATER
        20,20,0,0,20,20,7,3,ANIMATION_CYCLIC,3,(short)0xF000,
        //SPRITE_EXPLOSIONSURFACE
        12,17,0,0,12,17,6,3,ANIMATION_CYCLIC,3,(short)0xF000,
        //SPRITE_EXPLOSIONAIR
        17,12,0,0,17,12,5,2,ANIMATION_CYCLIC,3,(short)0xF000,
        //SPRITE_BLEBS
        3,7,0,0,3,7,5,1,ANIMATION_CYCLIC,3,(short)0xF000,
        //SPRITE_CHOPPERRIGHT
        12,7,0,0,12,7,4,1,ANIMATION_CYCLIC,3,(short)0xFFC0,
        //SPRITE_SUNKSHIP1

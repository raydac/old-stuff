...
boolean JustStarted = true;
 ...
 public void startme(){
  ...
  public void run(){
    if(JustStarted){
	      ...
	      try {
                canvas.start(67+10);
                GDS = new GameDataStorage("T_HUNT"/*canvas.client_sb.getGameID()*/,_maxsaveddata,_maxcharinname,_maxsavedgames,_maxrecoedsintoplist);
 ...
 private static int RMSCantOpen = 0;
 private static int DeleAsk = 1;
 private static int HelpTitle = 2;
 private static int OptionCMD = 3;
 private static int OffCMD = 4;
 private static int HelpCMD = 5;
 private static int AcceptCMD = 6;
 private static int RMSOStreamFail = 7;
 private static int CreditsImage = 8;
 private static int RMSMaxRecordsLimit = 9;
 private static int HighTitle = 10;
 private static int Light = 11;
 private static int DefPlayerName = 12;
 private static int LoadSaveCMD = 13;
 private static int ResumeGame = 14;
 private static int CreditsContent = 15;
 private static int NewRecordContent = 16;
 private static int EndGameCMD = 17;
 private static int PlayerNameTitle = 18;
 private static int HighCMD = 19;
 private static int DefSaveName = 20;
 private static int LoadTitle = 21;
 private static int RMSEmptyList = 22;
 private static int NoRecordsAvailableContent = 23;
 private static int GameMenuTitle = 24;
 private static int HelpContent = 25;
 private static int Sound = 26;
 private static int RMSReadingFail = 27;
 private static int RewriteAsk = 28;
 private static int ExitCMD = 29;
 private static int LevelName3 = 30;
 private static int PlayerNameAsk = 31;
 private static int LevelName2 = 32;
 private static int LevelName1 = 33;
 private static int ClearAllTitle = 34;
 private static int HighContent = 35;
 private static int BackCMD = 36;
 private static int NewGameTitle = 37;
 private static int RMSBaseNotOpen = 38;
 private static int RMSCantDelete = 39;
 private static int ExitGameAsk = 40;
 private static int YourScore = 41;
 private static int SpecialSection = 42;
 private static int CancelCMD = 43;
 private static int NoCMD = 44;
 private static int DeleTitle = 45;
 private static int AutoSaveName = 46;
 private static int MainMenuTitle = 47;
 private static int GameSaved = 48;
 private static int CreditsCMD = 49;
 private static int CreditsTitle = 50;
 private static int EndGameAsk = 51;
 private static int Reverse = 52;
 private static int ClearAllAsk = 53;
 private static int AreYouSureTitle = 54;
 private static int NewStage = 55;
 private static int SaveTitle = 56;
 private static int OptionTitle = 57;
 private static int NewGameCMD = 58;
 private static int Loading = 59;
 private static int GameNotLoaded = 60;
 private static int Language = 61;
 private static int RMSHasNoRoom = 62;
 private static int YesCMD = 63;
 private static int OnCMD = 64;
 private static int LoadSaveTitle = 65;
 private static int GameNotSaved = 66;

...
public class KillerTank extends Gamelet
{
    ...
    GameObject tank = new GameObject((byte) 28, (byte) 14, true);

    GameObject aircraftObj = new GameObject((byte) 20, (byte) 15, false);

    GameObject healPresent = new GameObject((byte) 8, (byte) 8, false);
    GameObject shieldPresent = new GameObject((byte) 8, (byte) 8, false);
    ...
    public KillerTank(int _screenWidth, int _screenHeight, Object _gameActionListener)
    {
	...
	targetRadius = 40;
        ...
        for (int i = 0; i < enemy.length; i++)
            enemy[i] = new EnemyObject((byte) 19, (byte) 17, false);
            //10x10 for 3410, 19x17 for 7210
        setDLeve(0);
    }

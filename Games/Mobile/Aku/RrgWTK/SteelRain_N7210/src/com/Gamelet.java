...
//===========================================================
     ...
     */
    public Object p_GameActionListener;
...
//#endif
     ...
     */
    public Gamelet(int _screenWidth, int _screenHeight, Object _gameActionListener)
    {
     ...
     */
    public abstract void nextGameStep(int i_Value);

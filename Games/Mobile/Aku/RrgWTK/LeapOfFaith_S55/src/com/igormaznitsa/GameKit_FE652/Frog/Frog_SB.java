...
public class Frog_SB implements StrategicBlock
{
    ...
    public static final int FIELD_HEIGHT = PLAYER_HEIGHT*2 + Car.CAR_HEIGHT*4;
    ...
    protected void playermove(int button)
    {
		...
		if (_game_state._playerframe>=Frog_GSR.FROG_JUMP_FRAMES)
		   _game_state._playerframe = Frog_GSR.FROG_JUMP_FRAMES-1;

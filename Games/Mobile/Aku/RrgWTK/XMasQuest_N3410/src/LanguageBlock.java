...
public class LanguageBlock
{
     ...
     */
    public void setLanguage(int _index,/*LoadListener*/GameArea _loadListener) throws IOException
    {
     ...
     * @throws IOException
     */
    public LanguageBlock(String _language_list,int _language_id,/*LoadListener*/GameArea _loadListener) throws IOException
    {

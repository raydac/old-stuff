...
public class AnimeObject
{
    ...
    public static short[] ai_AnimationValues = null;
/*
     = new short[]
     {
         ...
         //Appearance
         21, 25, 3, 2, ANIMATION_FREEZE, 0, 5,0,0,
         //Left
         21, 25, 6, 1, ANIMATION_NORMAL, 0, 5,5,5,
         //Right
         21, 25, 6, 1, ANIMATION_NORMAL, 0, 5,5,5,
         //Jump
         26, 25, 3, 1, ANIMATION_FREEZE, 0, 5,7,7,
         //Cower
         26, 25, 2, 3, ANIMATION_BACK, 0, 5,7,7,
         //Death
         28, 25, 3, 3, ANIMATION_FREEZE, 0, 5,8,8,
         //Fire
         28, 25, 3, 1, ANIMATION_NORMAL, 0, 5,8,8,
         ...
         //OBJECT_MOON
          ...
          //Appearance
          13, 23, 0, 0, ANIMATION_FREEZE, 0, 5,8,0,
          //Left
          13, 23, 0, 0, ANIMATION_FREEZE, 0, 5,8,0,
          //Right
          13, 23, 0, 0, ANIMATION_FREEZE, 0, 5,8,0,
          ...
          0, 0, 0, 0, 0, 0, 5,0,0,
          //Fire
          13, 23, 2, 2, ANIMATION_NORMAL, 0, 5,0,0,

...
//			     subVIBRA = 6,
	...
	String tmp=PlayerName;
	   ...
	   baos = null;
	   ret = true;
      } catch (Exception e){/*System.out.println("Save:"+e.getClass().getName()+" , "+e.getMessage()+"\nmem:"+Runtime.getRuntime().freeMemory()+
	"\nmaxsavedrecs:"+GDS.MAX_SAVEDRECORDS);
	System.out.println("Save: CANVAS->CLIENT->SAVE, IOEXCEPTION rec#"+n+"\n"+e.getMessage());*/}
      Runtime.getRuntime().gc();
      return ret;
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	_maxsaveddata = 1200;//canvas.client_sb.getMaxSizeOfSavedGameBlock();
	display.setCurrent(canvas);
	startme();
...
//   if(canvas.gameStatus!=canvas.titleStatus) ListItem.addCommand(cBack);
   ListItem.setCommandListener(this);
   return ListItem;
 }
...
//       lastIndex = -1;
       ...
       if ( scr instanceof List) lastIndex = ((List)scr).getSelectedIndex();
		 ...
		 ((Form)scr).set(((Form)scr).size()-1,new StringItem(saMSG[SaveTitle],PlayerName));
		 scr.removeCommand(cAccept);
...
//		    case subVIBRA:    setVibra((lastIndex==0));break;
	   ...
	   showSubMenu(menuState, subMenu);
		...
		SourceName = ((List)scr).getString(lastIndex);
		 switch (subMenu){
		    case subLOAD  : if(Load(SourceName)) {canvas.gameLoaded(); display.setCurrent(canvas);}
				      else {
...
boolean JustStarted = true;
 ...
 private static byte SaveTitle = (byte)0;
 private static byte LevelName1 = (byte)1;
 private static byte LevelName2 = (byte)2;
 private static byte LevelName3 = (byte)3;
 private static byte AutoSaveName = (byte)4;
 private static byte DefSaveName = (byte)5;
 private static byte HighContent = (byte)6;
 private static byte YourScore = (byte)7;
 private static byte OffCMD = (byte)8;
 private static byte NewGameCMD = (byte)9;
 private static byte GameNotLoaded = (byte)10;
 private static byte HelpCMD = (byte)11;
 private static byte CancelCMD = (byte)12;
 private static byte RMSEmptyList = (byte)13;
 private static byte HighCMD = (byte)14;
 private static byte YesCMD = (byte)15;
 private static byte Language = (byte)16;
 private static byte Reverse = (byte)17;
 private static byte PlayerNameTitle = (byte)18;
 private static byte DefPlayerName = (byte)19;
 private static byte GameSaved = (byte)20;
 private static byte LoadSaveCMD = (byte)21;
 private static byte RMSOStreamFail = (byte)22;
 private static byte NoRecordsAvailableContent = (byte)23;
 private static byte DeleAsk = (byte)24;
 private static byte HelpTitle = (byte)25;
 private static byte LoadTitle = (byte)26;
 private static byte MainMenuTitle = (byte)27;
 private static byte RMSHasNoRoom = (byte)28;
 private static byte HelpContent = (byte)29;
 private static byte RMSReadingFail = (byte)30;
 private static byte ExitGameAsk = (byte)31;
 private static byte OptionCMD = (byte)32;
 private static byte ClearAllAsk = (byte)33;
 private static byte GameMenuTitle = (byte)34;
 private static byte CreditsImage = (byte)35;
 private static byte AcceptCMD = (byte)36;
 private static byte CreditsTitle = (byte)37;
 private static byte RMSBaseNotOpen = (byte)38;
 private static byte Light = (byte)39;
 private static byte NoCMD = (byte)40;
 private static byte OnCMD = (byte)41;
 private static byte Sound = (byte)42;
 private static byte ExitCMD = (byte)43;
 private static byte AreYouSureTitle = (byte)44;
 private static byte CreditsContent = (byte)45;
 private static byte RMSCantDelete = (byte)46;
 private static byte PlayerNameAsk = (byte)47;
 private static byte RMSCantOpen = (byte)48;
 private static byte SpecialSection = (byte)49;
 private static byte OptionTitle = (byte)50;
 private static byte HighTitle = (byte)51;
 private static byte BackCMD = (byte)52;
 private static byte RewriteAsk = (byte)53;
 private static byte NewRecordContent = (byte)54;
 private static byte WaitPlease = (byte)55;
 private static byte CreditsCMD = (byte)56;
 private static byte NewStage = (byte)57;
 private static byte ResumeGame = (byte)58;
 private static byte NewGameTitle = (byte)59;
 private static byte DeleTitle = (byte)60;
 private static byte ClearAllTitle = (byte)61;
 private static byte GameNotSaved = (byte)62;
 private static byte RMSMaxRecordsLimit = (byte)63;
 private static byte Vibration = (byte)64;
 private static byte Loading = (byte)65;
 private static byte EndGameAsk = (byte)66;
 private static byte EndGameCMD = (byte)67;
 private static byte LoadSaveTitle = (byte)68;
}

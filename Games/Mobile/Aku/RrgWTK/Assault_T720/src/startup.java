...
//			     sGAMESAVE = 7;
    ...
    private void ErrorAlert(String title,int n){
     ...
     String s;
     if(saMSG==null || n>saMSG.length || n<0 || saMSG[n]==null) s="Error #"+Integer.toString(n);
       else s=saMSG[n];
	 Alert a=new Alert(title,s,null,AlertType.WARNING);
	 a.setTimeout(-2);
	 if(display.getCurrent() instanceof Alert)display.setCurrent(a);
	  else
...
//    private void saveHighScore(){}
	...
	dos=null; baos = null;
	   ...
	   if(e instanceof RMSException )
	      ErrorAlert("Saving options",((RMSException)e).Error_Code);
      }
     Runtime.getRuntime().gc();
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	startme();
     } catch(Exception e){e.printStackTrace(); killApp();}
    }
...
//       lastIndex = -1;
       ...
       if ( scr instanceof List) lastIndex = ((List)scr).getSelectedIndex();
	       ...
	       if (scr instanceof Form && cmd == cAccept){
	         PlayerName=new String(NameField.getString());
		 //NameField = null;
		 ((Form)scr).set(0, new StringItem(saMSG[Loading],""));
		 switch (subMenu) {
...
//if(saMSG.length<60)System.out.println("Not enough quantity of necessary resources (need:66, really loaded:"+saMSG.length+")");
    ...
    if(JustStarted){
	     ...
	     // while (!canvas.isShown()) Thread.yield();
		  ...
		  canvas.startIt();
                  ...
                  if (TopTen.GetNumRecords()<rHIGHSCORE) {
		    try{
                     ByteArrayOutputStream baos=new ByteArrayOutputStream();
	             DataOutputStream dos = new DataOutputStream(baos);
	             dos.writeUTF(NameMask);
 ...
 private final static byte ExitCMD = 0;
 private final static byte OptionCMD = 1;
 private final static byte NewGameCMD = 2;
 private final static byte LoadSaveCMD = 3;
 private final static byte HighCMD = 4;
 private final static byte EndGameCMD = 5;
 private final static byte HelpCMD = 6;
 private final static byte CreditsCMD = 7;
 private final static byte CancelCMD = 8;
 private final static byte BackCMD = 9;
 private final static byte YesCMD = 10;
 private final static byte NoCMD = 11;
 private final static byte OptionTitle = 12;
 private final static byte CreditsTitle = 13;
 private final static byte HelpTitle = 14;
 private final static byte LoadSaveTitle = 15;
 private final static byte HighTitle = 16;
 private final static byte SaveTitle = 17;
 private final static byte LoadTitle = 18;
 private final static byte DeleTitle = 19;
 private final static byte ClearAllTitle = 20;
 private final static byte AreYouSureTitle = 21;
 private final static byte PlayerNameTitle = 22;
 private final static byte NewGameTitle = 23;
 private final static byte PlayerNameAsk = 24;
 private final static byte DeleAsk = 25;
 private final static byte RewriteAsk = 26;
 private final static byte ClearAllAsk = 27;
 private final static byte CreditsContent = 28;
 private final static byte CreditsImage = 29;
 private final static byte HelpContent = 30;
 private final static byte ResumeGame = 31;
 private final static byte NewRecordContent = 32;
 private final static byte HighContent = 33;
 private final static byte NoRecordsAvailableContent = 34;
 private final static byte GameSaved = 35;
 private final static byte GameNotSaved = 36;
 private final static byte GameNotLoaded = 37;
 private final static byte RMSCantOpen = 38;
 ...
 private final static byte RMSOStreamFail = 43;
 private final static byte RMSReadingFail = 44;
 private final static byte RMSCantDelete = 45;
 private final static byte DefPlayerName = 46;
 private final static byte DefSaveName = 47;
 private final static byte Language = 48;
 private final static byte OnCMD = 49;
 private final static byte OffCMD = 50;
 private final static byte LevelName1 = 51;
 private final static byte LevelName2 = 52;
 private final static byte LevelName3 = 53;
 private final static byte Light = 54;
 private final static byte Sound = 55;
 private final static byte Vibration = 56;
 private final static byte Reverse = 57;
 private final static byte EndGameAsk = 58;
 private final static byte ExitGameAsk = 59;
 private final static byte AutoSaveName = 60;
 private final static byte YourScore = 61;
 private final static byte Loading = 62;
 private final static byte AcceptCMD = 63;
 private final static byte MainMenuTitle = 64;
 private final static byte GameMenuTitle = 65;
 private final static byte NewStage = 66;
 private final static byte SpecialSection = 67;

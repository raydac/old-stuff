...
public class Assault_SB extends StrategicBlock
{
    ...
    public static final int VIRTUALCELL_WIDTH = 8;
    public static final int VIRTUALCELL_HEIGHT = 10;
...
//        super(_screenWidth,_screenHeight,_gameActionListener);
        super(FIELD_WIDTH*VIRTUALCELL_WIDTH,FIELD_HEIGHT*VIRTUALCELL_HEIGHT,_gameActionListener);
    }
    ...
    private void generateNewAssaulter()
    {
        if (p_gsb.i_curassaulternumber < (NUMBER_MOVEOBJECTS >> 1))
        {
            if (getRandomInt(20) == 10)
            {
                ...
                p_gsb.initScrCoordsForMovingObject(p_obj,i_cellx,FIELD_HEIGHT - p_gsb.i_playeralt - 1);

...
public abstract class Game
{
    ...
    //#-
    private static final String GAMECLASS = "VideoBall";
    //#+
    //$private static final String GAMECLASS = "/*$GAMEMODE$*/";
     ...
     */
    public static final boolean initNewGame(Canvas _canvas,int _numberColors,byte[] _gameData)
    {
       ...
       i_PressedKey = 0;
        ...
        try
        {
            p_CurrentGame = (Game)(Class.forName(GAMECLASS)).newInstance();

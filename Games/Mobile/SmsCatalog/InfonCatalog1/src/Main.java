...
public class Main extends MIDlet implements Runnable
{
    ...
    public static final Object p_synchroObject = new Object();
    ...
    protected void startApp() throws MIDletStateChangeException
    {
        if (i_CurrentMidletState == STATE_INITING)
        {
            ...
            if (p_MainCanvas==null)
            {
                ...
                Coordinator.setFullCanvas(p_MainCanvas,true);
                //#if FCMIDP20
        ...
        switch (_screenId)
        {
            case App.SCR_LanguageSelectSCR:
            {
                ...
                try
                {
                    ...
                    p_languageBlock.setLanguage(i_Option_LanguageID);
    ...
    public void run()
    {
        ...
        try
        {
            ...
            p_languageBlock.initLanguageBlock(RESOURCE_LANGUAGELIST, i_Option_LanguageID);
            int i_oldLang = i_Option_LanguageID;
            i_Option_LanguageID = p_languageBlock.i_CurrentLanguageIndex;
            ...
            if (!App.init(p_MainCanvas.getClass(), this, DataStorage.hasSavedData() ? DataStorage.loadDataBlock() : null))  throw new Exception("Init error");
    ...
    {
        return p_languageBlock.as_TextStringArray[_index];
    }
        ...
        switch (_screenId)
        {
            ...
            */
            case App.SCR_LanguageSelectSCR:
            {
                ...
                for (int li = 0; li < p_languageBlock.as_LanguageNames.length; li++)
                {
                    p_list.append(p_languageBlock.as_LanguageNames[li], null);
                }
                return p_list;
            }
            default:
    ...
    public static boolean enableItem(int _screenId, int _itemId)
    {
        switch (_itemId)
        {
            ...
            case App.ITEM_LanguageSelectITM:
                return p_languageBlock.as_LanguageNames.length > 1;
            default:

...
if (lg_FinishImagePictured)
    ...
    public Object processGameAction(int _arg1, int _arg2, Object _obj1)
    {
     ...
     final static int [] ani_sequence = {1,1,0,2};
       ...
       final static int score_dx = 8;
       final static int score_dy = 5;
       final static int score_x = 9  -score_dx;
       final static int score_y = 3  -score_dy;

       final static int goals_dx = 6;
       final static int goals_dy = 5;
       final static int goals_x = 95 -goals_dx;
       final static int goals_y = 3  -goals_dy;

       final static int lives_x = 9;
       final static int lives_y = 112;

       final static int bar_x = 4;
       final static int bar1_y = 39;
       final static int bar2_y = 85;

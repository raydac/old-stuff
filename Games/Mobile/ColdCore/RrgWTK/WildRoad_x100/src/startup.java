...
public class startup extends MIDlet implements Runnable, CommandListener
{
    ...
    public static final int processGameAction(int _arg)
    {
        ...
        if (lg_Option_Sound)
        {
            switch(_arg)
            {
                case Gamelet.GAMEACTION_BIKERJUMP : SoundManager.playSound(SoundManager.SOUND_BIKERJUMP,1);break;
                case Gamelet.GAMEACTION_EXPLOSION : SoundManager.playSound(SoundManager.SOUND_EXPLOSION,1);break;
                case Gamelet.GAMEACTION_FIRING : SoundManager.playSound(SoundManager.SOUND_FIRING,1);break;
                case Gamelet.GAMEACTION_GASOLINETAKEN : SoundManager.playSound(SoundManager.SOUND_GASOLIN,1);break;
                case Gamelet.GAMEACTION_GRENADETHREW : SoundManager.playSound(SoundManager.SOUND_GRENADE,1);break;
            }
        }
 ...
 */
    ...
    protected static final void onLoadingGameResources(Class _this) throws Exception //ONEVENT onLoadingGameResources
    {
        ...
        Gamelet.ash_Paths = (short []) loadArray(_this,"/paths.bin");
        ...
        TileManager.initTileBackground(176,GAMESCREEN_HEIGHT,16,16,176,GAMESCREEN_HEIGHT);
        //#else
            //#if (VENDOR=="SIEMENS" && MODEL=="M55")
                //$TileManager.initTileBackground(100,GAMESCREEN_HEIGHT,10,10,GAMESCREEN_WIDTH,GAMESCREEN_HEIGHT);
            //#else
                //#if (VENDOR=="NOKIA" && MODEL=="3510")
                    //$TileManager.initTileBackground(96,GAMESCREEN_HEIGHT,8,8,96,GAMESCREEN_HEIGHT);
                //#else
                    //$TileManager.initTileBackground(132,GAMESCREEN_HEIGHT,12,12,132,GAMESCREEN_HEIGHT);
                //#endif
            //#endif
        //#endif
        ...
        //#if (VENDOR=="SIEMENS" && MODEL=="M55")
            //$TileManager.setGameRoomArray(10,ab_tileArray);
        //#else
            //#if (VENDOR=="NOKIA" && MODEL=="3510")
            //$TileManager.setGameRoomArray(12,ab_tileArray);
            //#else
            TileManager.setGameRoomArray(11,ab_tileArray);
            //#endif
        //#endif
    ...
    private static final boolean onInitNewGame(Class _this, int _selectedGameLevel) //ONEVENT onInitNewGame
    {
        ...
        TileManager.setXY(0,i_GameOptionalValue1);
    ...
    {
        // Смещаем бэкграунд
        i_GameOptionalValue1 -= ((Gamelet.BACKGROUND_SPEED_I8+0x7F)>>8);
        TileManager.setXY(0,i_GameOptionalValue1);
    }
    ...
    public static final void onAreaComponentPaint(Graphics _g, int _formIndex, int _x, int _y, int _width, int _height, int _channel) //ONEVENT onAreaComponentPaint
    {
        ...
        switch (_formIndex)
        {
            case MCFFormRender.MCF_FORM_MAINFORM:
            {
                switch(_channel)
                {
                    case 0:
                    {
                        ...
                        // отрисовка фона
                        //#-
                        TileManager.drawBufferToGraphics(_g,0,0);//drawBufferToGraphics(_g,0,0);
                        //#+

                        //#if (VENDOR=="NOKIA") || (VENDOR=="MOTOROLA") || (VENDOR=="SAMSUNG" || VENDOR=="LG") || (VENDOR=="SIEMENS" && MODEL=="M55") || (VENDOR=="SE" && MODEL=="T610")
                            //#if (VENDOR=="NOKIA" && MODEL=="6100") || (VENDOR=="SE" && MODEL=="T610") || (VENDOR=="SAMSUNG") || (VENDOR=="LG") || (VENDOR=="MOTOROLA" && MODEL=="C380")
                                //$TileManager.drawBufferToGraphics(_g,-2,0);
                            //#else
                        ...
                        //#if (VENDOR=="SE" && MODEL=="T610") || (VENDOR=="SAMSUNG") || (MODEL=="M55" && VENDOR=="SIEMENS")
                        //$_g.setClip(0,0,GAMESCREEN_WIDTH,GAMESCREEN_HEIGHT);
                        //#endif

                        //#if VENDOR=="SIEMENS" && MODEL=="M55"
                            // Заполняем последнюю линию, так как тайлов у нас только на 100 точек, а экран 101
                            //$_g.setColor(0x9C6331);
                            //$_g.drawLine(GAMESCREEN_WIDTH-1,0,GAMESCREEN_WIDTH-1,GAMESCREEN_HEIGHT-1);
                        //#endif

                        ImageManager.p_DestinationGraphics = _g;

                        /*
                        int i_rx1 =(Gamelet.I8_EDGELEFTX+0x7F)>>8;
                        int i_rx2 =(Gamelet.I8_EDGERIGHTX+0x7F)>>8;

                        int i_ry1 =(Gamelet.I8_EDGELEFTY+0x7F)>>8;
                        int i_ry2 =(Gamelet.I8_EDGERIGHTY+0x7F)>>8;
                        _g.drawLine(i_rx1,i_ry1,i_rx1,i_ry2);
                        _g.drawLine(i_rx2,i_ry1,i_rx2,i_ry2);
                        */

                        // Отрисовываем объекты на земле
                        SpriteCollection p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTIONID_PASSIVEOBJECTS];
                        ...
                        while(true)
                        {
                            ...
                            if (i_y>=GAMESCREEN_HEIGHT || i_x>=GAMESCREEN_WIDTH) continue;
                           ...
                           int i_mapOffset = -1;
                            ...
                            switch(i_Type)
                            {
                                case Gamelet.SPRITE_OBJ_JERRICAN :
                                {
                                    i_mapOffset = MAP_CANISTER;
                                };break;
                                case Gamelet.SPRITE_OBJ_MOTORCYCLIST :
                                {
                                    i_mapOffset = MAP_BIKERFALL_01;
                                };break;
                                case Gamelet.SPRITE_OBJ_MOTORCYCLE :
                                {
                                    i_mapOffset = MAP_BIKEFALL_01;
                                };break;
                            }

                            i_mapOffset += (i_frame*ImageManager.IMAGEINFO_LENGTH);

                            ImageManager.drawImage(i_mapOffset,i_x,i_y);
                        }

                        // Отрисовываем машину игрока
                        p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTIONID_PLAYER];
                        ...
                        while(true)
                        {
                            ...
                            switch(i_State)
                            {
                                case Gamelet.SPRITE_STATE_PLAYERCAR_BROKEN :
                                {
                                    i_mapOffset = MAP_PJ_DEAD;
                                };break;
                                case Gamelet.SPRITE_STATE_PLAYERCAR_MOVING :
                                {
                                    i_mapOffset = MAP_PJ_01;
                                };break;
                                case Gamelet.SPRITE_STATE_PLAYERCAR_STOPING :
                                {
                                    i_mapOffset = MAP_PJ_01;
                                };break;
                            }
                        ...
                        // Отрисовываем активные объекты
                        p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTIONID_ACTIVEOBJECTS];
                        ai_sprarray = p_col.ai_spriteDataArray;
                        p_col.initIterator();
                        while(true)
                        {
                            ...
                            switch(i_Type)
                            {
                               case Gamelet.SPRITE_OBJ_FLAMECAR :
                               {
                                   switch(i_State)
                                   {
                                       case Gamelet.SPRITE_STATE_FLAMECAR_BROKEN:{
                                           i_mapOffset = MAP_FIRECAR_DEAD;
                                       };break;
                                       case Gamelet.SPRITE_STATE_FLAMECAR_MOVING:{
                                           i_mapOffset = MAP_FIRECAR_01;
                                       };break;
                                       case Gamelet.SPRITE_STATE_FLAMECAR_STOPING:{
                                           i_mapOffset = MAP_FIRECAR_01;
                                       };break;
                                   }
                               };break;
                               case Gamelet.SPRITE_OBJ_MOTORCYCLE :
                               {
                                   switch(i_State)
                                   {
                                       case Gamelet.SPRITE_STATE_MOTORCYCLE_MOVING:
                                       {
                                           i_mapOffset = MAP_BIKER_01;
                                       };break;
                                   }
                               };break;
                               case Gamelet.SPRITE_OBJ_GRENADECAR :
                               {
                                   switch(i_State)
                                   {
                                       case Gamelet.SPRITE_STATE_GRENADECAR_BROKEN:{
                                           i_mapOffset = MAP_GREN_DEAD;
                                       };break;
                                       case Gamelet.SPRITE_STATE_GRENADECAR_MOVING:{
                                           i_mapOffset = MAP_GREN_01;
                                       };break;
                                       case Gamelet.SPRITE_STATE_GRENADECAR_STOPING:{
                                           i_mapOffset = MAP_GREN_02;
                                       };break;
                                   }
                               };break;
                               case Gamelet.SPRITE_OBJ_TARANCAR :
                               {
                                   switch(i_State)
                                   {
                                       case Gamelet.SPRITE_STATE_TARANCAR_CAR1BROKEN:
                                       {
                                           i_mapOffset = MAP_TARAN_DEAD;
                                       };break;
                                       case Gamelet.SPRITE_STATE_TARANCAR_CAR1MOVING:{
                                           i_mapOffset = MAP_TARAN_01;
                                       };break;
                                       case Gamelet.SPRITE_STATE_TARANCAR_CAR1STOPING:{
                                           i_mapOffset = MAP_TARAN_01;
                                       };break;
                                       case Gamelet.SPRITE_STATE_TARANCAR_CAR2BROKEN:
                                       {
                                           i_mapOffset = MAP_TARAN2_DEAD;
                                       };break;
                                       case Gamelet.SPRITE_STATE_TARANCAR_CAR2MOVING:{
                                           i_mapOffset = MAP_TARAN2_01;
                                       };break;
                                       case Gamelet.SPRITE_STATE_TARANCAR_CAR2STOPING:{
                                           i_mapOffset = MAP_TARAN2_01;
                                       };break;
                                   }
                               } ;break;
                               case Gamelet.SPRITE_OBJ_SPECIALZONE: continue;
                            }
                            i_mapOffset += (i_frame*ImageManager.IMAGEINFO_LENGTH);
                        ...
                        // Отрисовываем объекты в воздухе
                        p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTIONID_OVERROADOBJECTS];
                        ai_sprarray = p_col.ai_spriteDataArray;
                        p_col.initIterator();
                        while(true)
                        {
                            ...
                            switch(i_Type)
                            {
                                case Gamelet.SPRITE_OBJ_FLAMEBLOB : {
                                    i_mapOffset = MAP_FIREBALL_01;
                                }break;
                                case Gamelet.SPRITE_OBJ_GRENADE : {
                                    i_mapOffset = MAP_GRENADE_01;
                                };break;
                                case Gamelet.SPRITE_OBJ_MOTORCYCLIST :
                                {
                                    switch(i_State)
                                    {
                                        case Gamelet.SPRITE_STATE_MOTORCYCLIST_JUMPINGLEFT:
                                        {
                                            i_mapOffset = MAP_BIKERJUMP_LEFT;
                                        };break;
                                        case Gamelet.SPRITE_STATE_MOTORCYCLIST_JUMPINGRIGHT:
                                        {
                                            i_mapOffset = MAP_BIKERJUMP_RIGHT;
                                        };break;
                                    }
                                };break;
                                case Gamelet.SPRITE_OBJ_EXPLOSION :
                                {
                                    i_mapOffset = MAP_BLAST_01;
                                };break;
                                case Gamelet.SPRITE_OBJ_SMOKE :
                                {
                                    i_mapOffset = MAP_SMOKE_01;
                                };break;
                            }
                    ...
                    {
                        // попытки
                        Image p_attImage = p_GameForm.ap_Images[MCFFormRender.MCF_IMG_rul];
                        int i_height = p_attImage.getHeight();
                        int i_att = (Gamelet.i_PlayerAttemptions-1);
                        _g.setClip(_x,_y,_width,GAMESCREEN_HEIGHT);
                        while(i_att!=0)
                        {
                            _g.drawImage(p_attImage,_x,_y,0);
                            _y+=i_height;
                            i_att--;
                        }
                    ...
                    {
                        // топливо
                        Image p_attImage = p_GameForm.ap_Images[MCFFormRender.MCF_IMG_canistra];
                        int i_height = p_attImage.getHeight();
                        _y+=i_height;
                        int i_barH = ((((Gamelet.i8_CurrentPlayerFuel<<8)/Gamelet.MAXFUEL)*i_height)+0x7F)>>8;
                        _g.setClip(_x,_y-i_barH,_width,i_barH);
                        _g.drawImage(p_attImage,_x,_y-i_height,0);
                    };break;
                }
    ...
    {
        p_GameForm.selectForm(MCFFormRender.MCF_FORM_MAINFORM);
...
//#if (VENDOR=="NOKIA" && MODEL=="7650") || (VENDOR=="MOTOROLA" && MODEL=="E398")
    private static final int MAP_BIKEFALL_01 = 0;
    private static final int MAP_BIKEFALL_02 = 7;
    private static final int MAP_BIKEFALL_03 = 14;
    private static final int MAP_BIKERFALL_01 = 21;
    private static final int MAP_BIKERFALL_02 = 28;
    private static final int MAP_BIKERFALL_03 = 35;
    private static final int MAP_BIKERFALL_04 = 42;
    private static final int MAP_BIKERJUMP_LEFT = 49;
    private static final int MAP_BIKERJUMP_RIGHT = 56;
    private static final int MAP_BIKER_01 = 63;
    private static final int MAP_BIKER_02 = 70;
    private static final int MAP_BLAST_01 = 77;
    private static final int MAP_BLAST_02 = 84;
    private static final int MAP_BLAST_03 = 91;
    private static final int MAP_BLAST_04 = 98;
    private static final int MAP_BLAST_05 = 105;
    private static final int MAP_CANISTER = 112;
    private static final int MAP_FIREBALL_01 = 119;
    private static final int MAP_FIREBALL_02 = 126;
    private static final int MAP_FIREBALL_03 = 133;
    private static final int MAP_FIREBALL_04 = 140;
    private static final int MAP_FIRECAR_01 = 147;
    private static final int MAP_FIRECAR_02 = 154;
    private static final int MAP_FIRECAR_DEAD = 161;
    private static final int MAP_GRENADE_01 = 168;
    private static final int MAP_GRENADE_02 = 175;
    private static final int MAP_GRENADE_03 = 182;
    private static final int MAP_GRENADE_04 = 189;
    private static final int MAP_GRENADE_05 = 196;
    private static final int MAP_GRENADE_06 = 203;
    private static final int MAP_GRENADE_07 = 210;
    private static final int MAP_GRENADE_08 = 217;
    private static final int MAP_GREN_01 = 224;
    private static final int MAP_GREN_02 = 231;
    private static final int MAP_GREN_DEAD = 238;
    private static final int MAP_PJ_01 = 245;
    private static final int MAP_PJ_02 = 252;
    private static final int MAP_PJ_DEAD = 259;
    private static final int MAP_SMOKE_01 = 266;
    private static final int MAP_SMOKE_02 = 273;
    private static final int MAP_SMOKE_03 = 280;
    private static final int MAP_SMOKE_04 = 287;
    private static final int MAP_TARAN2_01 = 294;
    private static final int MAP_TARAN2_02 = 301;
    private static final int MAP_TARAN2_DEAD = 308;
    private static final int MAP_TARAN_01 = 315;
    private static final int MAP_TARAN_02 = 322;
    private static final int MAP_TARAN_DEAD = 329;
//#endif
...
//#if (VENDOR=="MOTOROLA" && MODEL=="C380") || (VENDOR=="SIEMENS" && MODEL=="C65")
private static final int MAP_BIKEFALL_01 = 0;
private static final int MAP_BIKEFALL_02 = 7;
private static final int MAP_BIKEFALL_03 = 14;
private static final int MAP_BIKERFALL_01 = 21;
...
//#_if (VENDOR=="MOTOROLA" && MODEL=="C380") || (VENDOR=="SIEMENS" && MODEL=="C65")
//#global IMAGES_INFO_LENGTH = 7
//#global IMAGES_DYNAMIC =false
//#global IMAGES_FLIPPEDLINK =false
//#global IMAGES_EXTERNAL =false
...
//#if (VENDOR=="SE" && MODEL=="T610") || (VENDOR=="SAMSUNG") || (VENDOR=="LG")
private static final int MAP_BIKEFALL_01 = 0;
private static final int MAP_BIKEFALL_02 = 7;
private static final int MAP_BIKEFALL_03 = 14;
private static final int MAP_BIKERFALL_01 = 21;
...
//#_if (VENDOR=="SE" && MODEL=="T610") || (VENDOR=="SAMSUNG") || (VENDOR=="LG")
//#global IMAGES_INFO_LENGTH = 7
//#global IMAGES_DYNAMIC =false
//#global IMAGES_FLIPPEDLINK =false
...
private static final int MAP_BLAST_03 = 91;
private static final int MAP_BLAST_04 = 98;
private static final int MAP_BLAST_06 = 105;
private static final int MAP_CANISTER = 112;
private static final int MAP_FIREBALL_01 = 119;
private static final int MAP_FIREBALL_02 = 126;
private static final int MAP_FIREBALL_03 = 133;

...
public class startup extends MIDlet implements Runnable, CommandListener
{
        ...
        while (lg_cycle)
        {
            switch (i_MidletMode)
            {
                ...
                case MODE_GAMEFINAL:
                {
                    ...
                    final String s_imageResource = Gamelet.i_PlayerState == Gamelet.PLAYER_WIN ? makeNameWinImageForLevel() : RESOURCE_LOSTIMAGE;
                    try
                    {
                        //#if MCF_SPLASH
                    ...
                    if (i_gameletState == Gamelet.STATE_OVER)
                    {
                        ...
                        switch (Gamelet.i_PlayerState)
                        {
                            case Gamelet.PLAYER_LOST:
                            {
                                ...
                                if (i_selectedGameStage == STAGENUMBER_FIRST)
                                {
    ...
    private static final int STAGENUMBER_LAST = 5;
    ...
    public static final int processGameAction(int _arg)
    {
        ...
        if (lg_Option_Sound)
        {
            switch (_arg)
            {
                case Gamelet.GAMEACTION_OPPONENTMOVEEND:
                {
                    SoundManager.playSound(SoundManager.SOUND_OPPMOVE,1);
                }
                ;
                break;
                case Gamelet.GAMEACTION_OPPONENTTAKE:
                {
                    SoundManager.playSound(SoundManager.SOUND_OPPTAKE,1);
                }
                ;
                break;
                case Gamelet.GAMEACTION_PLAYERMOVE:
                {
                    SoundManager.playSound(SoundManager.SOUND_PLMOVE,1);
                }
                ;
                break;
                case Gamelet.GAMEACTION_PLAYERTAKE:
                {
                    SoundManager.playSound(SoundManager.SOUND_PLATAKE,1);
                }
                ;
                break;
            }
    ...
    public static final void onAreaComponentPaint(Graphics _g, int _formIndex, int _x, int _y, int _width, int _height, int _channel) //ONEVENT onAreaComponentPaint
    {
        ...
        try
        {
            ...
            switch (_formIndex)
            {
                case MCFFormRender.MCF_FORM_STAGE1:
                case MCFFormRender.MCF_FORM_STAGE2:
                case MCFFormRender.MCF_FORM_STAGE3:
                case MCFFormRender.MCF_FORM_STAGE4:
                case MCFFormRender.MCF_FORM_STAGE5:
                {
                    switch (_channel)
                    {
                        case 0:
                        {
                            if (p_TableImage != null)
                            {
                                _g.drawImage(p_TableImage, _x, _y, 0);
                            }
                        }
                        ;
                        break;
                ...
                case MCFFormRender.MCF_FORM_GAMEAREA:
                {
                    ...
                    switch (_channel)
                    {
                        ...
                        {
                            //Колода оппонента
                            switch (Gamelet.i_OpponentCardsPosition)
                            {
                                case 0:
                                {
                                }
                                ...
                                {
                                    ImageManager.p_DestinationGraphics = _g;
                                    ImageManager.drawImage(MAP_BACK, _x, _y);
                                }
                                ;
                                break;
                                default:
                                {
                                    _g.drawImage(MCFFormRender.ap_Images[MCFFormRender.MCF_IMG_coloda], _x, _y, 0);
                                }
                            }
                        }
                        ;
                        ...
                        {
                            //Колода игрока
                            switch (Gamelet.i_PlayerCardsPosition)
                            {
                                case 0:
                                {
                                }
                        ...
                        {
                            //Куча оппонента
                            switch (Gamelet.i_OpponentHeapCardsNumber)
                            {
                                case 0:
                                {
                                }
                                ...
                                {
                                    ImageManager.p_DestinationGraphics = _g;
                                    ImageManager.drawImage(MAP_BACK_2, _x, _y);
                                }
                                ;
                                break;
                                default:
                                {
                                    _g.drawImage(MCFFormRender.ap_Images[MCFFormRender.MCF_IMG_back4], _x, _y, 0);
                                }
                            }
                        }
                        ;
                        ...
                        {
                            //Куча игрока
                            switch (Gamelet.i_PlayerHeapCardsNumber)
                            {
                                case 0:
                                {
                                }
                        ...
                        case 5:
                        {
                            ...
                            if (Gamelet.i_CurrentGameSubmode == Gamelet.SUBMODE_WAITPLAYERMOVE)
                            {
                                if ((i_CurrentModeTickCounter % 5) < 3)
                                {
                                    _g.drawImage(MCFFormRender.ap_Images[MCFFormRender.MCF_IMG_yourturn], _x, _y, 0);
                                }
                            }
                        }
                        ;
                        ...
                        case 6:
                        {
                            ...
                            drawScores(_g,_x,_y,2,Gamelet.i_PlayerCardsPosition);
                        }
                        ;
                        break;
                        case 7:
                        {
                            //Очки игрока
                            drawScores(_g,_x,_y,2,Gamelet.i_PlayerHeapCardsNumber);
                        }
                        ;
                        break;
                        case 8:
                        {
                            //Очки оппонента
                            drawScores(_g,_x,_y,2,Gamelet.i_OpponentHeapCardsNumber);
                        }
                        ;
                        break;
                        case 9:
                        {
                            ...
                            final int CARD_WIDTH = 22;
                            final int CARD_HEIGHT = 31;
                            //#else
                                //#if VENDOR=="NOKIA" && MODEL=="3510"
                                    //$final int CARD_WIDTH = 12;
                                    //$final int CARD_HEIGHT = 15;
                                //#else
                                    //#if VENDOR=="SIEMENS" && MODEL=="CX65"
                                        //$final int CARD_WIDTH = 20;
                                        //$final int CARD_HEIGHT = 30;
                                    //#else
                                        //#if VENDOR=="SIEMENS" && MODEL=="M55"
                                            //$final int CARD_WIDTH = 15;
                                            //$final int CARD_HEIGHT = 20;
                                        //#else
                                            //$final int CARD_WIDTH = 19;
                                            //$final int CARD_HEIGHT = 26;
                                        //#endif
                                    //#endif
                                //#endif
                            //#endif

                            //Слой перемещаемых карт
                            SpriteCollection p_col = Gamelet.ap_SpriteCollections[0];
                            int [] ai_sprarray = p_col.ai_spriteDataArray;

                            int i_card  = 0 ;
                            p_col.initIterator();
                            for(int li=0;li<ai_sprarray.length;li+=SpriteCollection.SPRITEDATA_LENGTH)
                            {
                                int i_sprOffset = li;
                                if (!p_col.isSpriteActive(i_sprOffset)) continue;

                                int i_xy = p_col.getSpriteScreenXY(i_sprOffset);
                                int i_x = i_xy >> 16;
                                int i_y = (short) i_xy;

                                final int i_wh = p_col.getSpriteWidthHeight(i_sprOffset);
                                ...
                                boolean lg_drawShadow = false;
                                switch (i_State)
                                {
                                    case Gamelet.SPRITE_STATE_CARD_BACK:
                                    {
                                        i_spr = MAP_BACK;
                                    }
                                    ;
                                    break;
                                    case Gamelet.SPRITE_STATE_CARD_FACE:
                                    {
                                        lg_drawShadow = true;
                                        int i_val = p_col.getOptionalData(i_sprOffset);

                                        switch (i_val >>> 4)
                                        {
                                            case Gamelet.CARDMASK_CROSSES:
                                            {
                                                i_spr = MAP_CROSS10_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.CARDMASK_DIAMONDS:
                                            {
                                                i_spr = MAP_DIAM10_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.CARDMASK_HEARTS:
                                            {
                                                i_spr = MAP_HEART10_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.CARDMASK_SPADES:
                                            {
                                                i_spr = MAP_SPADE10_01;
                                            }
                                            ;
                                            break;
                                        }
                                        ...
                                        switch (i_val & 0xF)
                                        {
                                            case 6:
                                            {
                                                i_spr += (MAP_CROSS6_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 7:
                                            {
                                                i_spr += (MAP_CROSS7_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 8:
                                            {
                                                i_spr += (MAP_CROSS8_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 9:
                                            {
                                                i_spr += (MAP_CROSS9_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 10:
                                            {
                                                i_spr += (MAP_CROSS10_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 11:
                                            {
                                                i_spr += (MAP_CROSSJACK_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 12:
                                            {
                                                i_spr += (MAP_CROSSQUEEN_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 13:
                                            {
                                                i_spr += (MAP_CROSSKING_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                            case 14:
                                            {
                                                i_spr += (MAP_CROSSACE_01-MAP_CROSS10_01);
                                            }
                                            ;
                                            break;
                                        }
                                    ...
                                    ;
                                    break;
                                    case Gamelet.SPRITE_STATE_CARD_TWOBACK:
                                    {
                                        i_spr = MAP_BACK_2;
                                    }
                                    ;
                                ...
                                _g.setColor(0xCCCCCC);
                                _g.fillRect(_x+i_x+2,_y+i_y+2,CARD_WIDTH,CARD_HEIGHT);

                                _g.setColor(0x000000);
                                _g.drawRect(_x+i_x-1,_y+i_y-1,CARD_WIDTH+2,CARD_HEIGHT+2);
                                }

                                ImageManager.drawImage(i_spr, _x + i_x, _y + i_y);
                            }
                        }
                        ;
                        break;
    ...
    private static final void onPaintGameStage(Graphics _g) //ONEVENT onPaintGameStage
    {
        ...
        MCFFormRender.selectForm(MCFFormRender.MCF_FORM_STAGE1 + (i_selectedGameStage - 1));
        MCFFormRender.paint(_g, GAMESCREEN_OFFSETX, GAMESCREEN_OFFSETY, false);
    ...
    private static Image p_TableImage;

    private static final boolean loadImageForLevel()
    {
        p_TableImage = null;
        Runtime.getRuntime().gc();
        String s_name = "/lvl_" + (i_selectedGameLevel + 1) + "_" + i_selectedGameStage + ".png";
        try
        {
            p_TableImage = Image.createImage(s_name);
            return true;
        }
        catch (IOException e)
        {
    ...
    private static final String makeNameWinImageForLevel()
    {
        p_TableImage = null;
        Runtime.getRuntime().gc();
        String s_name = "/lvl_" + (i_selectedGameLevel + 1) + "_w.png";
        return s_name;
    }
...
//TODO ДАННЫЕ IMAGE MANAGERa
    ...
    //#-
    private static final int MAP_BACK_2 = 0;
    private static final int MAP_BACK = 7;
    private static final int MAP_CROSS10_01 = 14;
    private static final int MAP_CROSS6_01 = 21;
    private static final int MAP_CROSS7_01 = 28;
    private static final int MAP_CROSS8_01 = 35;
    private static final int MAP_CROSS9_01 = 42;
    private static final int MAP_CROSSACE_01 = 49;
    private static final int MAP_CROSSJACK_01 = 56;
    private static final int MAP_CROSSKING_01 = 63;
    private static final int MAP_CROSSQUEEN_01 = 70;
    private static final int MAP_DIAM10_01 = 77;
    private static final int MAP_DIAM6_01 = 84;
    private static final int MAP_DIAM7_01 = 91;
    private static final int MAP_DIAM8_01 = 98;
    private static final int MAP_DIAM9_01 = 105;
    private static final int MAP_DIAMACE_01 = 112;
    private static final int MAP_DIAMJACK_01 = 119;
    private static final int MAP_DIAMKING_01 = 126;
    private static final int MAP_DIAMQUEEN_01 = 133;
    private static final int MAP_HEART10_01 = 140;
    private static final int MAP_HEART6_01 = 147;
    private static final int MAP_HEART7_01 = 154;
    private static final int MAP_HEART8_01 = 161;
    private static final int MAP_HEART9_01 = 168;
    private static final int MAP_HEARTACE_01 = 175;
    private static final int MAP_HEARTJACK_01 = 182;
    private static final int MAP_HEARTKING_01 = 189;
    private static final int MAP_HEARTQUEEN_01 = 196;
    private static final int MAP_SPADE10_01 = 203;
    private static final int MAP_SPADE6_01 = 210;
    private static final int MAP_SPADE7_01 = 217;
    private static final int MAP_SPADE8_01 = 224;
    private static final int MAP_SPADE9_01 = 231;
    private static final int MAP_SPADEACE_01 = 238;
    private static final int MAP_SPADEJACK_01 = 245;
    private static final int MAP_SPADEKING_01 = 252;
    private static final int MAP_SPADEQUEEN_01 = 259;
    //#+

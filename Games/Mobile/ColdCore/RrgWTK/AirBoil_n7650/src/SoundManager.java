...
public class SoundManager
{
    ...
    public static final int SOUND_PLAYER_HET_AMMO = 4;
    public static final int SOUND_PLAYER_GET_LIFE = 5;
    public static final int SOUND_VICTORY = 6;
    public static final int SOUND_FIGHTER = 7;
    public static final int SOUND_PLAYER_FALL = 8;
    public static final int SOUND_ENEMY_HIT = 9;

    private static final int SOUNDS_NUMBER = 10;
    ...
    {
        //#if (VENDOR=="SIEMENS" && MODEL=="M50") || (VENDOR=="NOKIA" && MIDP=="1.0") || (VENDOR=="LG")
//$                20000, // Theme
//$                10000, // Lost
//$                10000, // Win
//$                400, // explosion
//$                1500, // player get ammo
//$                1500, // player get life
//$                2800, // victory
//$                1500, // fighter
//$                600, // player fall
//$                300, // enemy hit

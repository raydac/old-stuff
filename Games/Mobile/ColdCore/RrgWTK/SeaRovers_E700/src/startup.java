    ...
    private void initImageBlock(String resource_name) throws Exception
    {
      ...
      li--;
                ...
                try
                {
                    if ((i_imageflag & 4)!=0)
                    {
                      ab_ImageOffset[i_imageindx][0] = ds.readByte(); 
                      ab_ImageOffset[i_imageindx][1] = ds.readByte(); 
                    }
...
p_imageForOutput = getImage(2);
    ...
    private void gamePlayDrawing(Graphics _graphics)
    {
        ...
        int li,i_sx,i_sy,i_idx,i_w,i_h,i_x, i_y, shMark, loMark;
        Sprite p_spr;
        Image img;
       ...
       li = ((p_Gamelet.i_wayLength >> 8) & 63) - 63 ;
       for(; li < GAMESCREEN_HEIGHT; li += tiled_water.getHeight())
       {
          _graphics.drawImage(tiled_water,0,li,0);
       }
       ...
       for(li=0;li<p_Gamelet.ap_Sprites.length;li++)
       {
            ...
            if (p_spr.lg_SpriteActive)
            {
                ...
                {
                    case MobileGameletImpl.SPRITE_TRADESHIP:
                    case MobileGameletImpl.SPRITE_TRADESHIP_FIRE_LEFT:
                    case MobileGameletImpl.SPRITE_TRADESHIP_FIRE_RIGHT:
                    case MobileGameletImpl.SPRITE_TRADESHIP_DAMAGED:
                    case MobileGameletImpl.SPRITE_TRADESHIP_BEFORE_DEAD:
                         {
                             sort_buffer[shMark++] = p_spr;
                         }
                         continue;
                    case MobileGameletImpl.SPRITE_TRADESHIP_DEAD:
                         {
                             i_idx = IMG_GALEON_0001 + ((p_spr.i_Frame < GALEON_DEATH_FRAMES) ? p_spr.i_Frame : GALEON_DEATH_FRAMES -1);

                             i_x = ab_ImageOffset[i_idx][0] - (GALEON_WIDTH>>1) - GALEON_COOR_X;
                             i_y = ab_ImageOffset[i_idx][1] - (GALEON_HEIGHT>>1) - GALEON_COOR_Y;
                         }
                         break;
                    case MobileGameletImpl.SPRITE_BATTLESHIP:
                    case MobileGameletImpl.SPRITE_BATTLESHIP_FIRE_LEFT:
                    case MobileGameletImpl.SPRITE_BATTLESHIP_FIRE_RIGHT:
                    case MobileGameletImpl.SPRITE_BATTLESHIP_BEFORE_DEAD:
                         {
                             sort_buffer[shMark++] = p_spr;
                         }
                         continue;
                    case MobileGameletImpl.SPRITE_BATTLESHIP_DEAD:
                         {
                             i_idx = IMG_FREGAT_0001 + ((p_spr.i_Frame < FRIGAT_DEATH_FRAMES) ? p_spr.i_Frame : FRIGAT_DEATH_FRAMES -1);

                             i_x = ab_ImageOffset[i_idx][0] - (FRIGAT_WIDTH>>1);
                             i_y = ab_ImageOffset[i_idx][1] - (FRIGAT_HEIGHT>>1);
                         }
                         break;
                    case MobileGameletImpl.SPRITE_COKCBOAT_LEFT:
                    case MobileGameletImpl.SPRITE_COKCBOAT_RIGHT:
                    case MobileGameletImpl.SPRITE_BOAT:
                    case MobileGameletImpl.SPRITE_BOAT_BEFORE_DEAD:
                         {
                             sort_buffer[shMark++] = p_spr;
                         }
                         continue;
                    case MobileGameletImpl.SPRITE_BOAT_DEAD:
                         {
                             i_idx = IMG_BOT_0001 + ((p_spr.i_Frame < BOT_DEATH_FRAMES) ? p_spr.i_Frame : BOT_DEATH_FRAMES -1);

                             i_x = ab_ImageOffset[i_idx][0] - (BOT_WIDTH>>1);
                             i_y = ab_ImageOffset[i_idx][1] - (BOT_HEIGHT>>1);
                         }
                         break;
                    default: continue;
                }
        ...
        p_spr = p_Gamelet.pPlayerCorsar;

        if(p_spr.i_ObjectType == MobileGameletImpl.SPRITE_CORSAR_DEAD )
        {
            if(p_spr.i_Frame < CORSAR_DEATH_FRAMES)
            {
                i_idx = IMG_PLAYER_0000 + p_spr.i_Frame;
                img = getImage(i_idx);

                i_x = p_spr.i_mainX>>8;
                i_y = p_spr.i_ScreenY + p_spr.i_height>>8;

                i_x += ab_ImageOffset[i_idx][0] - (CORSAR_DEAD_WIDTH>>1);
                i_y += ab_ImageOffset[i_idx][1] - CORSAR_DEAD_HEIGHT;
          ...
          else
                {
                       ...
                       i_sx = 0;
                       i_sy = ((p_Gamelet.i_wayLength>>8) & 3) - 3;    


                       i_x = (p_spr.i_mainX>>8)+2;
                       i_y = (p_spr.i_ScreenY + p_spr.i_height >> 8) + i_sy -6;

                       i_sy = p_Gamelet.i_CorsarVSpeed>>8;
                       i_sx = -p_Gamelet.i_CorsarHSpeed;


                       switch(p_spr.i_ObjectType)
                       {
                          case MobileGameletImpl.SPRITE_CORSAR_LEFT:
                               {
                                   i_x += 5;
                                   i_sx += 0x100;
                               }
                               break;
                          case MobileGameletImpl.SPRITE_CORSAR_LBACK:
                               {
                                   i_x += 5;
                                   i_sx += 0x80;
                               }
                               break;
                          case MobileGameletImpl.SPRITE_CORSAR_RIGHT:
                               {
                                   if(p_spr.i_Frame >=1 )
                                   {
                                       i_x -= 5;
                          ...
                          case MobileGameletImpl.SPRITE_CORSAR_RBACK:
                               {
                                   i_x -= 2;
                                   i_sx -= 0x10;
                               }
                       ...
                       for(; li >= 0; li--)
                       {
                          img = getImage(IMG_SPLASHES_01 + li);
       ...
       if(p_spr.lg_SpriteActive)
       {
            ...
            {
               default:
               case MobileGameletImpl.SPRITE_ISLAND: li = IMG_ISLAND; i_y -=2; break;
               case MobileGameletImpl.SPRITE_ROCK:   li = IMG_STONE01; break;
               case MobileGameletImpl.SPRITE_STONE:  li = IMG_STONE02; break;
            }
         img = getImage(li);
       ...
       p_spr = p_Gamelet.pBoat;

       if(p_spr.lg_SpriteActive)
       {
            if(p_spr.i_ObjectType == MobileGameletImpl.SPRITE_COKCBOAT_LEFT)
            {
               li = IMG_BOAT_LEFT_0000;
            }
             else
                 {
                    li = IMG_BOAT_RIGHT_0000;
                 }
            li += p_spr.i_Frame;
            img = getImage(li);
            ...
            i_y = (p_spr.i_mainY >> 8) - (img.getHeight()>>1);
       ...
       for(li=0; li < shMark ;li++)
       {
            ...
            switch(p_spr.i_ObjectType)
            {
                ...
                case MobileGameletImpl.SPRITE_TRADESHIP_BEFORE_DEAD:
                     {
                         i_idx = IMG_GALEON_0001;

                         i_x += ab_ImageOffset[i_idx][0] - (GALEON_WIDTH>>1) - GALEON_COOR_X;
                         i_y += ab_ImageOffset[i_idx][1] - (GALEON_HEIGHT>>1) - GALEON_COOR_Y;
                         _graphics.drawImage(getImage(i_idx), i_x, i_y, 0);
                         continue;
                     }
                case MobileGameletImpl.SPRITE_TRADESHIP_DEAD:
                     continue;
                ...
                case MobileGameletImpl.SPRITE_COKCBOAT_LEFT:
                     {
                         i_idx = IMG_BOAT_LEFT_0000 + p_spr.i_Frame;
                     }
                     break;
                case MobileGameletImpl.SPRITE_COKCBOAT_RIGHT:
                     {
                         i_idx = IMG_BOAT_RIGHT_0000 + p_spr.i_Frame;
                     }
                     break;
                case MobileGameletImpl.SPRITE_BOAT:
                case MobileGameletImpl.SPRITE_BOAT_BEFORE_DEAD:
        ...
        if(p_spr.i_ObjectType != MobileGameletImpl.SPRITE_CORSAR_DEAD)
        {
            ...
            {
                default:
                case MobileGameletImpl.SPRITE_CORSAR:
                     {
                          i_idx = IMG_BRIG_PLAYER_0002;
                     }
                     break;
                case MobileGameletImpl.SPRITE_CORSAR_FIRE_LEFT:
                     {
                         sort_buffer[loMark++] = p_spr;
                         i_idx = IMG_BRIG_PLAYER_0002;
                     }
                     break;
                case MobileGameletImpl.SPRITE_CORSAR_FIRE_RIGHT:
                     {
                         sort_buffer[loMark++] = p_spr;
                         i_idx = IMG_BRIG_PLAYER_0002;
                     }
                ...
                case MobileGameletImpl.SPRITE_CORSAR_LEFT:
                     {
                          i_idx = IMG_BRIG_PLAYER_0001 - p_spr.i_Frame;
                     }
                     break;
                case MobileGameletImpl.SPRITE_CORSAR_RIGHT:
                     {
                          i_idx = IMG_BRIG_PLAYER_0003 + p_spr.i_Frame;
                     }
                     break;
                case MobileGameletImpl.SPRITE_CORSAR_LBACK:
                     {
                          i_idx = IMG_BRIG_PLAYER_0001;
                     }
                     break;
                case MobileGameletImpl.SPRITE_CORSAR_RBACK:
                     {
                          i_idx = IMG_BRIG_PLAYER_0003;
                     }
                     break;
            }
            ...
            i_x += ab_ImageOffset[i_idx][0] - (CORSAR_WIDTH>>1);
            i_y += ab_ImageOffset[i_idx][1] - CORSAR_HEIGHT;
            _graphics.drawImage(img, i_x, i_y, 0);
       }
       ...
       for(li=0;li<loMark;li++)
       {
            ...
            i_idx = p_spr.i_Frame;
            if(i_idx >= EXPLOSION_FRAMES) continue;
            ...
            switch(p_spr.i_ObjectType)
            {
                ...
                case MobileGameletImpl.SPRITE_BATTLESHIP_FIRE_LEFT:
                            {
                               i_idx += IMG_EXPLOZ_LEFT_0000;
                               img = getImage(i_idx);

                               i_x += ab_ImageOffset[i_idx][0] - EXPLOSION_WIDTH;
                               i_y += ab_ImageOffset[i_idx][1] - (EXPLOSION_HEIGHT>>1);

                               _graphics.drawImage(img, i_x+2,i_y,0);
                            }
                            break;
                case MobileGameletImpl.SPRITE_CORSAR_FIRE_RIGHT:
                case MobileGameletImpl.SPRITE_TRADESHIP_FIRE_RIGHT:
                case MobileGameletImpl.SPRITE_BATTLESHIP_FIRE_RIGHT:
                            {
                               i_idx += IMG_EXPLOZ_RIGHT_0000;
                               img = getImage(i_idx);

                               i_x += (p_spr.i_width >> 8) + ab_ImageOffset[i_idx][0];
                               i_y += ab_ImageOffset[i_idx][1] - (EXPLOSION_HEIGHT>>1);
        ...
        drawBar(_graphics,(GAMESCREEN_WIDTH - BAR_WIDTH >> 1) + 3, 5
                ,p_Gamelet.pPlayerCorsar.i_Force
                ,p_Gamelet.pPlayerCorsar.i_MaxForce
                ,0xff0000 - (Math.abs(16-(i_Timer&31))<<19),0xcccccc);
        ...
        i_x = 1; i_y = GAMESCREEN_HEIGHT - img.getHeight()-1;
        if(p_Gamelet.lg_FireLocation)
        {
           _graphics.drawImage(getImage(IMG_INDIKATOR), i_x, i_y, 0);
        }
     ...
     i_y = 0;
     font.drawDigits(_graphics,i_x,i_y,4,p_Player.m_iPlayerGameScores,10);
...
if (lg_FinishImagePictured)
    ...
    public int processGameAction(int _arg)
    {
          ...
          switch(_arg)
          {
               case MobileGameletImpl.GAMEACTION_CORSAR_FIRE:
                          {
                             i_action_sound = SND_KORABL_STRELAYET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_CORSAR_DEAD:
                          {
                             i_action_sound = SND_KORABL_TONET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_BATTLESHIP_FIRE:
                          {
                             i_action_sound = SND_KORABL_STRELAYET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TRADESHIP_FIRE:
                          {
                             i_action_sound = SND_KORABL_STRELAYET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_BOAT_DEAD:
                          {
                            i_action_sound = SND_KORABL_TONET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_BATTLESHIP_DEAD:
                          {
                             i_action_sound = SND_KORABL_TONET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TRADESHIP_DEAD:
                          {
                            i_action_sound = SND_KORABL_TONET_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TRADESHIP_DAMAGED:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_COCKBOAT:
                          {
                             i_action_sound = SND_OTPRAVKA_GRUPPY_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_COCKBOAT_RETURN:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_COCKBOAT_RETURNED:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_COCKBOAT_LOST:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_SHIP_COLLISION:
                          {
                             i_action_sound = SND_KORABL_STOLKNULSA_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_SHIP_CRASHED:
                          {
                            i_action_sound = SND_KORABL_STOLKNULSA_MMF;
                          }
                          break;
    ...
    public Object processGameAction(int _arg1, int _arg2, Object _obj1)
    {
     ...
     drawDigits font;
     Image tiled_water;
     final static int EXPLOSION_WIDTH = 24;
     final static int EXPLOSION_HEIGHT = 52;
     final static int EXPLOSION_FRAMES = 3;

     final static int CORSAR_WIDTH = 58;
     final static int CORSAR_HEIGHT = 58;

     final static int CORSAR_DEAD_WIDTH = 33;
     final static int CORSAR_DEAD_HEIGHT = 62;
     final static int CORSAR_DEATH_FRAMES = 4;

     final static int FRIGAT_WIDTH = 30;
     final static int FRIGAT_HEIGHT = 67;
     final static int FRIGAT_DEATH_FRAMES = 4;

     final static int BOT_WIDTH = 22;
     final static int BOT_HEIGHT = 47;
     final static int BOT_DEATH_FRAMES = 4;

     final static int GALEON_WIDTH = 22;
     final static int GALEON_HEIGHT = 47;
     final static int GALEON_DEATH_FRAMES = 4;

     final static int GALEON_COOR_X = 2;
     final static int GALEON_COOR_Y = 5;
     ...
     private void prepareGraphics()
     {
        ...
        Image img   = getImage(IMG_WATER);
        ib_ImageArray[IMG_WATER] = null;
        tiled_water = Image.createImage(GAMESCREEN_WIDTH, img.getHeight());
        Graphics  g = tiled_water.getGraphics();
        for (int i = 0; i < GAMESCREEN_WIDTH; i += img.getWidth())
        {
             g.drawImage(img,i,0,0);
        }
     }
   ...
   private void drawBar(Graphics _graphics, int x, int y, int cur, int max, int col1, int col2)
   {
    ...
    int i_sound_queue;
    long l_sound_queue_timestamp = 0;

    void setSoundItemPriority()
    {
                             int [] sort_idx = {

SND_KORABL_STRELAYET_MMF ,1576,
SND_OTPRAVKA_GRUPPY_MMF  ,1029,
SND_KORABL_TONET_MMF     ,1401,
SND_KORABL_STOLKNULSA_MMF,1537,
SND_FINAL_MMF            ,0,
SND_START_MMF            ,0
                             };
...
private static final int IMG_TITLE128X160 = 0;
private static final int IMG_FINAL128X160 = 1;
private static final int IMG_WIN = 2;
private static final int IMG_DEMO = 3;
private static final int IMG_SCORE = 4;
private static final int IMG_ICON_LIFE = 5;
private static final int IMG_EXPLOZ_LEFT_0000 = 6;
private static final int IMG_EXPLOZ_LEFT_0001 = 7;
private static final int IMG_EXPLOZ_LEFT_0002 = 8;
private static final int IMG_EXPLOZ_RIGHT_0000 = 9;
private static final int IMG_EXPLOZ_RIGHT_0001 = 10;
private static final int IMG_EXPLOZ_RIGHT_0002 = 11;
private static final int IMG_BRIG_PLAYER_0000 = 12;
private static final int IMG_BRIG_PLAYER_0001 = 13;
private static final int IMG_BRIG_PLAYER_0002 = 14;
private static final int IMG_BRIG_PLAYER_0003 = 15;
private static final int IMG_BRIG_PLAYER_0004 = 16;
private static final int IMG_BOAT_LEFT_0000 = 17;
private static final int IMG_BOAT_LEFT_0001 = 18;
private static final int IMG_BOAT_LEFT_0002 = 19;
private static final int IMG_BOAT_RIGHT_0000 = 20;
private static final int IMG_BOAT_RIGHT_0001 = 21;
private static final int IMG_BOAT_RIGHT_0002 = 22;
private static final int IMG_BOT_0000 = 23;
private static final int IMG_BOT_0001 = 24;
private static final int IMG_BOT_0002 = 25;
private static final int IMG_BOT_0003 = 26;
private static final int IMG_BOT_0005 = 27;
private static final int IMG_FREGAT_0000 = 28;
private static final int IMG_FREGAT_0001 = 29;
private static final int IMG_FREGAT_0002 = 30;
private static final int IMG_FREGAT_0003 = 31;
private static final int IMG_FREGAT_0005 = 32;
private static final int IMG_GALEON_0000 = 33;
private static final int IMG_GALEON_0001 = 34;
private static final int IMG_GALEON_0002 = 35;
private static final int IMG_GALEON_0003 = 36;
private static final int IMG_GALEON_0005 = 37;
private static final int IMG_PLAYER_0000 = 38;
private static final int IMG_PLAYER_0001 = 39;
private static final int IMG_PLAYER_0002 = 40;
private static final int IMG_PLAYER_0004 = 41;
private static final int IMG_WATER = 42;
private static final int IMG_ISLAND = 43;
private static final int IMG_STONE01 = 44;
private static final int IMG_STONE02 = 45;
private static final int IMG_INDIKATOR = 46;
private static final int IMG_SPLASHES_01 = 47;
private static final int IMG_SPLASHES_02 = 48;
private static final int IMG_SPLASHES_03 = 49;
private static final int TOTAL_IMAGES_NUMBER = 50;

private static final int SND_FINAL_MMF = 0;
private static final int SND_KORABL_STOLKNULSA_MMF = 1;
private static final int SND_KORABL_STRELAYET_MMF = 2;
private static final int SND_KORABL_TONET_MMF = 3;
private static final int SND_OTPRAVKA_GRUPPY_MMF = 4;

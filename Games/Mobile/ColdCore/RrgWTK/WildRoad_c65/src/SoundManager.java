...
public class SoundManager
{
    ...
    public static final int SOUND_BIKERJUMP = 3;
    public static final int SOUND_EXPLOSION = 4;
    public static final int SOUND_FIRING = 5;
    public static final int SOUND_GRENADE = 6;
    public static final int SOUND_GASOLIN = 7;

    private static final int SOUNDS_NUMBER = 8;

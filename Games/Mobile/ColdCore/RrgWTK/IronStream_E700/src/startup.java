...
p_imageForOutput = getImage(2);
    ...
    private void gamePlayDrawing(Graphics _graphics)
    {
        ...
        int li,i_sx,i_sy,i_w,i_h,i_x, i_y, loMark,hiMark,shMark,tkMark, i_ndx;
        Sprite p_spr;
        Image img;
   ...
   _graphics.translate(0,16);
        ...
        shMark = 0;
        tkMark = shells.length;

        for(li=0;li<MobileGameletImpl.MAX_SPRITES_NUMBER;li++)
        {
            ...
            if (p_spr.lg_SpriteActive)
            {
                ...
                {
                    case MobileGameletImpl.SPRITE_TANK_SHELL:           shells[shMark++] = p_spr; continue;

                    case MobileGameletImpl.SPRITE_ENEMY_TANK_SHELL:     shells[shMark++] = p_spr; continue;
                    case MobileGameletImpl.SPRITE_EXPLOSION:            sort_buffer[--hiMark] = p_spr; continue;
                    case MobileGameletImpl.SPRITE_SHELL_EXPLOSION:      sort_buffer[--hiMark] = p_spr; continue;

                    case MobileGameletImpl.SPRITE_HOUSE:                continue;
                    case MobileGameletImpl.SPRITE_HOUSE_BARELY_DAMAGED: continue;
                    case MobileGameletImpl.SPRITE_HOUSE_DAMAGED:        sort_buffer[loMark++] = p_spr; continue;
                    case MobileGameletImpl.SPRITE_HOUSE_RUINS:          i_ndx = IMG_RUINS; break;

                    case MobileGameletImpl.SPRITE_SMOKE:                sort_buffer[--hiMark] = p_spr; continue;

                    case MobileGameletImpl.SPRITE_ENEMY_TANK:
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_LEFT:
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_RIGHT:
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_TURN_LEFT:
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_TURN_RIGHT:
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_BACK_LEFT:
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_BACK_RIGHT:shells[--tkMark] = p_spr; continue;
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_FIRE:      shells[--tkMark] = p_spr;
                                                                        sort_buffer[loMark++] = p_spr; continue;
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_DEAD:      i_ndx = IMG_ENEMY_DEATH_01; break;
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_RUINS:     i_ndx = IMG_ENEMY_DEATH_01 + p_spr.i_Frame; break;
                    default:
                            continue;
                }
        ...
        if(p_spr.i_ObjectType == MobileGameletImpl.SPRITE_TANK_DEAD)
        {
              i_x = p_spr.i_mainX>>8;
              i_y = p_spr.i_mainY>>8;
              img = getImage(IMG_PLAYER_DEATH);
              _graphics.drawImage(img, i_x - (img.getWidth()>>1), i_y - (img.getHeight()>>1), 0);
        }


        for(li=tkMark ; li < shells.length ;li++)
        {
            p_spr = shells[li];
            shells[li] = null;
            ...
            switch(p_spr.i_ObjectType)
            {
                case MobileGameletImpl.SPRITE_ENEMY_TANK:           i_ndx = IMG_ENEMY_DOWN; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_LEFT:      i_ndx = IMG_ENEMY_RIGHT; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_RIGHT:     i_ndx = IMG_ENEMY_LEFT; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_TURN_LEFT: i_ndx = IMG_ENEMY_DOWN; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_TURN_RIGHT:i_ndx = IMG_ENEMY_DOWN; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_BACK_LEFT: i_ndx = IMG_ENEMY_RIGHT; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_BACK_RIGHT:i_ndx = IMG_ENEMY_LEFT; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_FIRE:      i_ndx = IMG_ENEMY_DOWN; break;
                default:
                        continue;
            }
        ...
        if(p_spr.i_ObjectType != MobileGameletImpl.SPRITE_TANK_DEAD)
        {
             if (p_Gamelet.getGameWorldState() == MobileGamelet.GAMEWORLDSTATE_PLAYED || (i_Timer&2)==0)
             {
               i_x = (p_spr.i_mainX>>8);
               i_y = p_spr.i_mainY>>8;
               img = getImage(IMG_PLAYER);
               _graphics.drawImage(img, i_x - (img.getWidth()>>1), i_y - (img.getHeight()>>1), 0);
        ...
        for(li=0;li<loMark;li++)
        {
            ...
            switch(p_spr.i_ObjectType)
            {
                    case MobileGameletImpl.SPRITE_TANK:                 i_ndx = IMG_TURRET_TOP; i_x--; i_y-=6; break;
                    case MobileGameletImpl.SPRITE_TANK_APPEAR:          i_ndx = IMG_TURRET_LEFT;i_x-=5;i_y--; break;
                    case MobileGameletImpl.SPRITE_TANK_TURN_GUN:        i_ndx = IMG_TURRET_LEFT;i_x-=5;i_y--; break;
                    case MobileGameletImpl.SPRITE_TANK_LEFT:            i_ndx = IMG_TURRET_TOP; i_x--; i_y-=6; break;
                    case MobileGameletImpl.SPRITE_TANK_RIGHT:           i_ndx = IMG_TURRET_TOP; i_x--; i_y-=6; break;
                    case MobileGameletImpl.SPRITE_TANK_FIRE:
                                    {
                                      i_x--;
                                      img = getImage(IMG_TURRET_TOP);
                                      i_sx = i_x - (img.getWidth()>>1);
                                      i_sy = i_y - (img.getHeight()>>1) -5;
                                       _graphics.drawImage(img, i_sx, i_sy, 0);

                                      i_ndx = IMG_SHOT_TOP;
                                      i_y-=16;
                                    }
                                    break;
                    case MobileGameletImpl.SPRITE_ATTEMPTION_LOST:      i_ndx = IMG_TURRET_TOP; i_x--; i_y-=6; break;
                    case MobileGameletImpl.SPRITE_HOUSE_DAMAGED:        i_ndx = IMG_FIRE_0000 + p_spr.i_Frame; i_y-=4; break;
                    case MobileGameletImpl.SPRITE_ENEMY_TANK_FIRE:      i_ndx = IMG_SHOT_DOWN; i_y+=10;break;
                    default:
                            continue;
            }
            img = getImage(i_ndx);
        ...
        for(li=hiMark;li<sort_buffer.length;li++)
        {
            ...
            switch(p_spr.i_ObjectType)
            {
                case MobileGameletImpl.SPRITE_EXPLOSION:        i_ndx = IMG_EXPLOZ_TANK_0000 + p_spr.i_Frame; break;
                case MobileGameletImpl.SPRITE_SHELL_EXPLOSION:  i_ndx = IMG_EXPLOZ_MISSLE_0000 + p_spr.i_Frame; break;
                case MobileGameletImpl.SPRITE_SMOKE:
                        {
                            i_ndx = IMG_SMOKE_TANK_0003 - p_spr.i_Frame;
                            i_sx = p_spr.i_Frame * p_spr.i_maxTimeDelay + p_spr.i_Delay;
                            i_y -= i_sx << 1;
                                i_x-= i_sx;
                        }
                        break;
        ...
        for(li=0;li<shMark;li++)
        {
            ...
            switch(p_spr.i_ObjectType)
            {
                case MobileGameletImpl.SPRITE_TANK_SHELL:          i_ndx = IMG_MISSILE_ENEMY; break;
                case MobileGameletImpl.SPRITE_ENEMY_TANK_SHELL:    i_ndx = IMG_MISSILE_PLAYER; break;
                default:
                        continue;
            }
            img = getImage(i_ndx);
   ...
   _graphics.translate(0,-16);
   _graphics.drawImage(getImage(IMG_PANEL_TOP),0,0,0);
   _graphics.drawImage(getImage(IMG_PANEL_BOTTOM),0,GAMESCREEN_HEIGHT-16,0);
          ...
          font.drawDigits(_graphics,score_x,score_y,4,p_Player.m_iPlayerGameScores,10);
...
if (lg_FinishImagePictured)
    ...
    public int processGameAction(int _arg)
    {
          ...
          switch(_arg)
          {
               case MobileGameletImpl.GAMEACTION_TANK_READY:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TANK_TURN_GUN:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TANK_LEFT:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TANK_RIGHT:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TANK_STOP:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TANK_FIRE:
                          {
                            i_action_sound = SND_TANKS_FIRE_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_TANK_DEAD:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ATTEMPTION_LOST:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ENEMY_TANK_COLLISION:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ENEMY_TANK_TURN:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ENEMY_TANK_FIRE:
                          {
                            i_action_sound = SND_TANKS_FIRE_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ENEMY_TANK_DEAD:
                          {
                            i_action_sound = SND_VZRYV_TANKA_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ENEMY_TANK_GENERATED:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_BURN_HOUSE:
                          {
                            i_action_sound = SND_GORIT_DOM_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_DEAD_HOUSE:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_SHELL:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_ENEMY_SHELL:
                          {
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_SHELL_EXPLOSION:
                          {
                            i_action_sound = SND_VZRYV_SNARYADA_MMF;
                          }
                          break;
               case MobileGameletImpl.GAMEACTION_EXPLOSION:
                          ...
                          break;
               case MobileGameletImpl.GAMEACTION_SMOKE:
                          {
                          }
                          break;
          }
    ...
    public Object processGameAction(int _arg1, int _arg2, Object _obj1)
    {
     ...
     Sprite [] shells = new Sprite[MobileGameletImpl.MAX_SPRITES_NUMBER];

     int score_x, score_y;

     final static int unsafe_zone = 20;
     final static int border_line = GAMESCREEN_HEIGHT - unsafe_zone;

     private void prepareGraphics()
     {
        font              = new drawDigits(getImage(IMG_NUMBERS),10);

        score_x = GAMESCREEN_WIDTH - font.fontWidth*4 - 2;
        score_y = 2;
     }
    ...
    {
                             int [] sort_idx = {
SND_GORIT_DOM_MMF      ,1473,
SND_TANKS_FIRE_MMF     ,699,
SND_VZRYV_SNARYADA_MMF ,452,
SND_VZRYV_TANKA_MMF    ,918,
SND_FINAL_MMF          ,0,
SND_START_MMF          ,0
...
private static final int IMG_ENEMY_DEATH_01 = 6;
private static final int IMG_ENEMY_DEATH_02 = 7;
private static final int IMG_ENEMY_DEATH_03 = 8;
private static final int IMG_ENEMY_DEATH_04 = 9;
private static final int IMG_ENEMY_DOWN = 10;
private static final int IMG_ENEMY_LEFT = 11;
private static final int IMG_ENEMY_RIGHT = 12;
private static final int IMG_TURRET_LEFT = 13;
private static final int IMG_TURRET_TOP = 14;
private static final int IMG_EXPLOZ_MISSLE_0000 = 15;
private static final int IMG_EXPLOZ_MISSLE_0001 = 16;
private static final int IMG_EXPLOZ_MISSLE_0002 = 17;
private static final int IMG_EXPLOZ_MISSLE_0003 = 18;
private static final int IMG_EXPLOZ_TANK_0000 = 19;
private static final int IMG_EXPLOZ_TANK_0001 = 20;
private static final int IMG_EXPLOZ_TANK_0002 = 21;
private static final int IMG_EXPLOZ_TANK_0003 = 22;
private static final int IMG_EXPLOZ_TANK_0004 = 23;
private static final int IMG_SMOKE_TANK_0000 = 24;
private static final int IMG_SMOKE_TANK_0001 = 25;
private static final int IMG_SMOKE_TANK_0002 = 26;
private static final int IMG_SMOKE_TANK_0003 = 27;
private static final int IMG_FIRE_0000 = 28;
private static final int IMG_FIRE_0001 = 29;
private static final int IMG_FIRE_0002 = 30;
private static final int IMG_FIRE_0003 = 31;
private static final int IMG_FIRE_0004 = 32;
private static final int IMG_ICON_LIFE = 33;
private static final int IMG_MISSILE_ENEMY = 34;
private static final int IMG_MISSILE_PLAYER = 35;
private static final int IMG_NUMBERS = 36;
private static final int IMG_PLAYER = 37;
private static final int IMG_PLAYER_DEATH = 38;
private static final int IMG_RUINS = 39;
private static final int IMG_SHOT_DOWN = 40;
private static final int IMG_SHOT_TOP = 41;
private static final int IMG_PANEL_TOP = 42;
private static final int IMG_PANEL_BOTTOM = 43;
private static final int TOTAL_IMAGES_NUMBER = 44;

private static final int SND_FINAL_MMF = 0;
private static final int SND_GORIT_DOM_MMF = 1;
private static final int SND_START_MMF = 2;
private static final int SND_TANKS_FIRE_MMF = 3;
private static final int SND_VZRYV_SNARYADA_MMF = 4;
private static final int SND_VZRYV_TANKA_MMF = 5;

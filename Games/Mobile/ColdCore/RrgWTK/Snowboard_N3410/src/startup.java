...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	_maxsaveddata = canvas.client_sb.getMaxSizeOfSavedGameBlock();
	display.setCurrent(canvas);
	startme();
...
*/
 ...
 private List mLoadSave(){
   ...
   return ListItem;
    ...
    private void showText(int title, int content){
       subMenu = subHIGHSCORE;
       Runtime.getRuntime().gc();
       Form a = new Form(saMSG[title]);
             a.append(saMSG[content]);
       a.addCommand(cBack);
       a.setCommandListener(this);
       display.setCurrent(a);
       a=null;
...
//					     display.setCurrent(LoadFailed(),(menuState==sMAIN?mLoad():mLoadSave()));
		 ...
		 if (GDS.getSavedGamesCount()<=0 && lastIndex>0) lastIndex++;
		   ...
		   case 2: showText(HelpTitle,HelpContent);break;
		   case 3: showSubMenu(sMAINOPTIONS,-1);break;
		   case 4: showHighScore();break;
		   case 5: showText(CreditsTitle,CreditsContent);break;
		   case 6: showSubMenu(menuState,subEXIT);break;
                 }
                }  else
                if (menuState == sGAME && subMenu<0){
		if(!canvas.autosaveCheck() && lastIndex>0)lastIndex++;
                 switch (lastIndex) {

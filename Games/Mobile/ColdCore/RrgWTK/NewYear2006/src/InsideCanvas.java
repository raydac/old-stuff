...
public class InsideCanvas extends javax.microedition.lcdui.Canvas implements Runnable, CommandListener
{
    ...
    protected Font p_MessageFont = Font.getFont(Font.FACE_PROPORTIONAL, Font.STYLE_BOLD, Font.SIZE_MEDIUM);
    ...
    private static final int BUTTON_UP = 50;
    private static final int BUTTON_DOWN = 56;
    private static final int BUTTON_LEFT = 52;
    private static final int BUTTON_RIGHT = 54;
    private static final int BUTTON_FIRE = 53;
    private static final int BUTTON_OPTIONAL_LEFT = 49;
    private static final int BUTTON_OPTIONAL_RIGHT = 51;


    private static final int BUTTON_SOFT_LEFT = -6;
    private static final int BUTTON_SOFT_RIGHT = -7;
    ...
    private static final int JOYSTICK_FIRE = -5;
    ...
    public void paint(Graphics _graphics)
    {
        ...
        switch (Main.i_CurrentMidletState)
        {
            ...
            case Main.STATE_WAITING:
            {
                ...
                _graphics.fillRect(0, 0, i_scrW, i_scrH);
                _graphics.setFont(p_msgFnt);
                String s_str = Main.getStringForIndex(App.WaitPleaseTXT);
                int i_strW = p_msgFnt.stringWidth(s_str);
                int i_strH = p_msgFnt.getHeight();

...
//        i_keySet = _dis.readUnsignedByte();
        i_spriteID = _dis.readByte();
        i_linkedSprite = _dis.readByte();
        lg_linkedSprite = _dis.readBoolean();

        i_TTL = _dis.readByte();
        i_deltaX = _dis.readShort();
        i_deltaY = _dis.readShort();
...
//        _dis.writeByte(i_keySet);
        ...
        _dis.writeByte(i_linkedSprite);
        _dis.writeBoolean(lg_linkedSprite);

        _dis.writeByte(i_TTL);
        _dis.writeShort(i_deltaX);
        _dis.writeShort(i_deltaY);

...
import com.igormaznitsa.midp.PhoneModels.PhoneStubImpl;
...
public class GameSoundBlock
{
    ...
    protected PhoneStubImpl p_stub;

    public GameSoundBlock(PhoneStubImpl _phonestub, String resource_name,LoadListener loadListener) throws IOException
    {

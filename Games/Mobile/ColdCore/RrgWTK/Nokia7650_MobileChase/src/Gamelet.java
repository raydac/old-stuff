...
//===========================================================
    ...
    // the pointer to an array resource stream
    ...
    /**
     * The timedelay value of the game main cycle
     */
    public int i_GameTimeDelay;

    /**
     * The number of attemptions
     */
     ...
     */
public startup p_GameActionListener;
     ...
     * @param _staticArrayResource the name of a resource file contains static array values, if not presented then null
     */
public Gamelet(int _screenWidth, int _screenHeight, startup _gameActionListener, String _staticArrayResource)
    {
    ...
    /**
     * Load the game state from an input stream
     */

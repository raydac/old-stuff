...
public class startup extends MIDlet implements Runnable, CommandListener
{
            ...
            //#endif
    {
        ...
        protected synchronized void keyPressed(int _key)
        {
    ...
    public static final int processGameAction(int _arg)
    {
        ...
        if (lg_Option_Sound)
        {
            switch (_arg)
            {
                ...
                {
                    SoundManager.playSound(SoundManager.SOUND_EXPLOSION,1);
                };break;
                case Gamelet.GAMEACTION_FLYINGOBJECTGENERATED :
                {
                    SoundManager.playSound(SoundManager.SOUND_FLYINGOBJECT,1);
                };break;
                case Gamelet.GAMEACTION_GROUNDFIRING :
                {
                    SoundManager.playSound(SoundManager.SOUND_GRNDFIRE,1);
                };break;
                case Gamelet.GAMEACTION_ROCKETLAUNCHED :
                {
                    SoundManager.playSound(SoundManager.SOUND_ROCKETLAUNCHED,1);
                };break;
            }
        }
    ...
    protected static final void onLoadingGameResources(Class _this) throws Exception //ONEVENT onLoadingGameResources
    {
        ...
        byte [] ab_tileArray = (byte[]) loadArray(_this, "/tile.bin");

        //#if (VENDOR=="NOKIA" && MODEL=="7650") || (VENDOR=="MOTOROLA" && MODEL=="E398")
            TileManager.initTileBackground(176, 80, 16, 16, 176, 80);
        //#else
            //#if (VENDOR=="NOKIA" && MODEL=="6100") || (VENDOR=="SE" && MODEL=="T610") || (VENDOR=="SIEMENS" && MODEL=="C65") || (VENDOR=="LG" && MODEL=="G1600") || (VENDOR=="MOTOROLA" && MODEL=="C380") || (VENDOR=="SAMSUNG" && (MODEL=="C100" || MODEL=="X100"))
                //$TileManager.initTileBackground(128, 55, 12, 11, 128, 55);
            //#else
                //#if VENDOR=="SIEMENS" && MODEL=="M55"
                    //$TileManager.initTileBackground(101, 35, 9, 7, 101, 35);
                //#endif
                //#if VENDOR=="SIEMENS" && MODEL=="CX65"
                    //$TileManager.initTileBackground(132, 65, 12, 13, 132, 65);
                //#endif
                //#if VENDOR=="NOKIA" && MODEL=="3510"
                    //$TileManager.initTileBackground(96, 30, 9, 6, 96, 30);
                //#endif
            //#endif
        //#endif

        Image [] ap_tiles = null;
        Image p_tileImg = null;
        ...
        TileManager.setGameRoomArray(220, ab_tileArray);
                ...
                case MCFFormRender.MCF_FORM_GAMEFORM:
                {
                    switch (_channel)
                    {
                        case 3:
                        {
                            // scores
                            _g.setClip(_x,_y,_width,_height);
                            drawScores(_g,_x,_y,5,Gamelet.getPlayerScore());
                        };break;
                        case 2:
                        {
                            // attemptions
                            int i_att = Gamelet.i_PlayerAttemptions;
                            _g.setClip(_x,_y,_width,_height);
                            Image p_att = p_GameForm.ap_Images[MCFFormRender.MCF_IMG_live_ico];
                            final int i_icow = p_att.getWidth();
                            int i_x = _x+_width-i_icow;
                            while(i_att>0)
                            {
                                _g.drawImage(p_att,i_x,_y,0);
                                i_x -= i_icow;
                                i_att--;
                            }
                        ...
                        case 1:
                        {
                             TileManager.drawBufferToGraphics(_g,_x,_y);

                            //#if SHOWSYS
                                drawCurrentTerrain(_g,_x,_y);
                            //#endif
                        };break;
                        case 0:
                        {
                            ...
                            while (true)
                            {
                                ...
                                switch (i_Type)
                                {
                                    case Gamelet.SPRITE_OBJ_PLAYER:
                                    {
                                        i_spriteMap = MAP_HELI_01;
                                        if (Gamelet.i_PlayerCantBeKilledCounter > 0)
                                        {
                                            if ((i_CurrentModeTickCounter & 0x1) == 0) continue;
                                        }
                                    }
                                    ;
                                    break;
                                    ...
                                    {
                                        i_spriteMap = MAP_BLAST01;
                                    }
                                    ;
                                    break;
                                }

                                i_spriteMap += (i_frame * ImageManager.IMAGEINFO_LENGTH);
                                ImageManager.drawImage(i_spriteMap, i_x, i_y);
                            ...
                            // Отрисовываем бомбы
                            p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTION_PLAYERBOMBS];
                            ...
                            while (true)
                            {
                                ...
                                switch (i_Type)
                                {
                                    case Gamelet.SPRITE_OBJ_PLAYERBOMB:
                                    {
                                        i_mapImage = MAP_BOMB01;
                                    }
                                    ;
                                    break;
                                }

                                i_mapImage += (i_frame * ImageManager.IMAGEINFO_LENGTH);
                                ImageManager.drawImage(i_mapImage, i_x, i_y);
                            ...
                            final int i_scr = 176 * SCALE_WIDTH;

                            // Отрисовываем Объекты летающие противника
                            p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTION_FLYINGENEMYOBJECTS];
                            ai_sprarray = p_col.ai_spriteDataArray;
                            p_col.initIterator();
                            ...
                            while (true)
                            {
                                int i_sprOffset = p_col.nextActiveSpriteOffset();
                                if (i_sprOffset < 0) break;
                                int i_x = ai_sprarray[i_sprOffset + SpriteCollection.SPRITEDATAOFFSET_SCREENX];
                                int i_y = ai_sprarray[i_sprOffset + SpriteCollection.SPRITEDATAOFFSET_SCREENY];
                                ...
                                switch (i_Type)
                                {
                                    case Gamelet.SPRITE_OBJ_DERIGIBLE:
                                    {
                                        i_mapImage = MAP_ZEPP_01;
                                    }
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_ENEMYCOPTER:
                                    {
                                        i_mapImage = MAP_HIND_01;
                                    }
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_ENEMYPLANE:
                                    {
                                        i_mapImage = MAP_PREY_01;
                                    }
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_ENEMYSHELL:
                                    {
                                        switch (i_State)
                                        {
                                            case Gamelet.SPRITE_STATE_ENEMYSHELL_LEFT:
                                            {
                                                i_mapImage = MAP_BULLETHOR;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_ENEMYSHELL_UP:
                                            {
                                                i_mapImage = MAP_BULLETVERT;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_ENEMYSHELL_UPLEFT:
                                            {
                                                i_mapImage = MAP_BULLETLV;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_ENEMYSHELL_UPRIGHT:
                                            {
                                                i_mapImage = MAP_BULLETVR;
                                            }
                                            ;
                                            break;
                                        }
                                    ...
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_ENEMYROCKET:
                                    {
                                        i_mapImage = MAP_ROCKET_01;
                                    }
                                    ;
                                    break;
                                    //#-
                            ...
                            // Отрисовываем Объекты наземные противника
                            p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTION_GROUNDENEMYOBJECTS];
                            ai_sprarray = p_col.ai_spriteDataArray;
                            p_col.initIterator();
                            ...
                            while (true)
                            {
                                int i_sprOffset = p_col.nextActiveSpriteOffset();
                                if (i_sprOffset < 0) break;
                                int i_x = ai_sprarray[i_sprOffset + SpriteCollection.SPRITEDATAOFFSET_SCREENX] - Gamelet.i8_TerrainPos;
                                int i_y = ai_sprarray[i_sprOffset + SpriteCollection.SPRITEDATAOFFSET_SCREENY];

                                int i_mx = ai_sprarray[i_sprOffset + SpriteCollection.SPRITEDATAOFFSET_MAINX] - Gamelet.i8_TerrainPos;
                                int i_my = ai_sprarray[i_sprOffset + SpriteCollection.SPRITEDATAOFFSET_MAINY];
                                i_mx = (i_mx + 0x7F) >> 8;
                                i_my = (i_my + 0x7F) >> 8;

                                if (i_x < (-40 * SCALE_WIDTH) || i_x > i_scr) continue;
                                ...
                                switch (i_Type)
                                {
                                    case Gamelet.SPRITE_OBJ_AAGUN:
                                    {
                                        switch (i_State)
                                        {
                                            case Gamelet.SPRITE_STATE_AAGUN_MOVINGLEFT:
                                            {
                                                i_mapImage = MAP_ZENIT_L_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_AAGUN_MOVINGRIGHT:
                                            {
                                                i_mapImage = MAP_ZENIT_R_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_AAGUN_TURNTOLEFT:
                                            {
                                                i_mapImage = MAP_ZEN_RAZV_RL01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_AAGUN_TURNTORIGHT:
                                            {
                                                i_mapImage = MAP_ZEN_RAZV_LR01;
                                            }
                                            ;
                                            break;
                                        }
                                    ...
                                    case Gamelet.SPRITE_OBJ_TANK:
                                    {
                                        switch (i_State)
                                        {
                                            case Gamelet.SPRITE_STATE_TANK_MOVINGLEFT:
                                            {
                                                i_mapImage = MAP_TANK_L_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_TANK_MOVINGRIGHT:
                                            {
                                                i_mapImage = MAP_TANK_R_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_TANK_TURNTOLEFT:
                                            {
                                                i_mapImage = MAP_TANK_RAZV_RL01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_TANK_TURNTORIGHT:
                                            {
                                                i_mapImage = MAP_TANK_RAZV_LR01;
                                            }
                                            ;
                                            break;
                                        }
                                    ...
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_RADAR:
                                    {
                                        i_mapImage = MAP_RADAR_01;
                                    }
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_ROCKETLAUNCHER:
                                    {
                                        switch (i_State)
                                        {
                                            case Gamelet.SPRITE_STATE_ROCKETLAUNCHER_OPENED:
                                            {
                                                i_mapImage = MAP_MSILO_02;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_ROCKETLAUNCHER_CLOSED:
                                            {
                                                i_mapImage = MAP_MSILO_01;
                                            }
                                            ;
                                            break;
                                        }
                                    ...
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_STORAGE:
                                    {
                                        i_mapImage = MAP_WAREHOUSE;
                                    }
                                    ;
                                    break;
                                    case Gamelet.SPRITE_OBJ_GUN:
                                    {
                                        switch (i_State)
                                        {
                                            case Gamelet.SPRITE_STATE_GUN_TOCENTER:
                                            {
                                                i_mapImage = MAP_TURRET_02;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_GUN_TOLEFT:
                                            {
                                                i_mapImage = MAP_TURRET_01;
                                            }
                                            ;
                                            break;
                                            case Gamelet.SPRITE_STATE_GUN_TORIGHT:
                                            {
                                                i_mapImage = MAP_TURRET_03;
                                            }
                                            ;
                                            break;
                                        }
                            ...
                            // Отрисовываем взрывы
                            p_col = Gamelet.ap_SpriteCollections[Gamelet.COLLECTION_EXPLOSIONS];
                            ai_sprarray = p_col.ai_spriteDataArray;
                            p_col.initIterator();
                            while (true)
                            {
    ...
    private synchronized final void onKeyReleased(int _keyCode) //ONEVENT onKeyReleased
    {
        switch (_keyCode)
        {
            case KEY_CODE_UP:
...
//TODO ДАННЫЕ IMAGE MANAGERa
    ...
    //#if SHOWSYS
    private static final void drawCurrentTerrain(Graphics _g,int _x,int _y)
    {
        _g.setClip(0,0,GAMESCREEN_WIDTH,GAMESCREEN_HEIGHT);

        int i_blw = (Gamelet.I8_BLOCKWIDTH+0x7f)>>8;
        int i_blh = (Gamelet.I8_BLOCKHEIGHT+0x7f)>>8;

        int i_y = _y;

        //int i_posOnTerrain = (Gamelet.i8_TerrainPos/Gamelet.I8_BLOCKWIDTH)%Gamelet.TERRAIN_CELLS_WIDTH;

        int i_posCoord = (Gamelet.i8_TerrainPos+0x7F)>>8;
        int i_posOnTerrain = i_posCoord/Gamelet.VIEWCELLWIDTH;
        i_posOnTerrain = (i_posOnTerrain<<1) + (i_posOnTerrain%(Gamelet.VIEWCELLWIDTH<<8)>=(Gamelet.VIEWCELLWIDTH<<7)? 1 : 0);
        i_posOnTerrain %= Gamelet.TERRAIN_CELLS_WIDTH;

        final int CELLSONSCREEN = 23;

        int i_x = _x-(i_posCoord%Gamelet.VIEWCELLWIDTH);


        _g.setColor(0x00FFFF);

        int i_cellW = (Gamelet.I8_BLOCKWIDTH+0x7F)>>8;

        for(int li=0;li<CELLSONSCREEN;li++)
        {
            int i_val = Gamelet.TERRAIN_MAP[i_posOnTerrain];

            int i_h = (((i_val+1)*Gamelet.I8_BLOCKHEIGHT)+0x7F)>>8;

            _g.drawRect(i_x,GAMESCREEN_HEIGHT-i_h,i_blw,i_h);

            i_posOnTerrain++;
            if (i_posOnTerrain==Gamelet.TERRAIN_CELLS_WIDTH) i_posOnTerrain = 0;
            i_x += i_cellW;
        }
    ...
    private static final int MAP_BLAST01 = 0;
    private static final int MAP_BLAST02 = 7;
    private static final int MAP_BLAST03 = 14;
    private static final int MAP_BLAST04 = 21;
    private static final int MAP_BLAST05 = 28;
    private static final int MAP_BOMB01 = 35;
    private static final int MAP_BOMB02 = 42;
    private static final int MAP_BOMB03 = 49;
    private static final int MAP_BULLETHOR = 56;
    private static final int MAP_BULLETLV = 63;
    private static final int MAP_BULLETVERT = 70;
    private static final int MAP_BULLETVR = 77;
    private static final int MAP_HELI_01 = 84;
    private static final int MAP_HELI_02 = 91;
    private static final int MAP_HELI_03 = 98;
    private static final int MAP_HIND_01 = 105;
    private static final int MAP_HIND_02 = 112;
    private static final int MAP_HIND_03 = 119;
    private static final int MAP_MSILO_01 = 126;
    private static final int MAP_MSILO_02 = 133;
    private static final int MAP_PREY_01 = 140;
    private static final int MAP_PREY_02 = 147;
    private static final int MAP_PREY_03 = 154;
    private static final int MAP_PREY_04 = 161;
    private static final int MAP_RADAR_01 = 168;
    private static final int MAP_RADAR_02 = 175;
    private static final int MAP_RADAR_03 = 182;
    private static final int MAP_RADAR_04 = 189;
    private static final int MAP_ROCKET_01 = 196;
    private static final int MAP_ROCKET_02 = 203;
    private static final int MAP_ROCKET_03 = 210;
    private static final int MAP_ROCKET_04 = 217;
    private static final int MAP_TANKRAZV1 = 224;
    private static final int MAP_TANKRAZV2 = 231;
    private static final int MAP_TANKRAZV3 = 238;
    private static final int MAP_TANK_L_01 = 245;
    private static final int MAP_TANK_L_02 = 252;
    private static final int MAP_TANK_L_03 = 259;
    private static final int MAP_TANK_RAZV_LR01 = 266;
    private static final int MAP_TANK_RAZV_LR02 = 273;
    private static final int MAP_TANK_RAZV_LR03 = 280;
    private static final int MAP_TANK_RAZV_RL01 = 287;
    private static final int MAP_TANK_RAZV_RL02 = 294;
    private static final int MAP_TANK_RAZV_RL03 = 301;
    private static final int MAP_TANK_R_01 = 308;
    private static final int MAP_TANK_R_02 = 315;
    private static final int MAP_TANK_R_03 = 322;
    private static final int MAP_TURRET_01 = 329;
    private static final int MAP_TURRET_02 = 336;
    private static final int MAP_TURRET_03 = 343;
    private static final int MAP_WAREHOUSE = 350;
    private static final int MAP_ZENIT_L_01 = 357;
    private static final int MAP_ZENIT_L_02 = 364;
    private static final int MAP_ZENIT_L_03 = 371;
    private static final int MAP_ZENIT_R_01 = 378;
    private static final int MAP_ZENIT_R_02 = 385;
    private static final int MAP_ZENIT_R_03 = 392;
    private static final int MAP_ZENRAZV1 = 399;
    private static final int MAP_ZENRAZV2 = 406;
    private static final int MAP_ZENRAZV3 = 413;
    private static final int MAP_ZEN_RAZV_LR01 = 420;
    private static final int MAP_ZEN_RAZV_LR02 = 427;
    private static final int MAP_ZEN_RAZV_LR03 = 434;
    private static final int MAP_ZEN_RAZV_RL01 = 441;
    private static final int MAP_ZEN_RAZV_RL02 = 448;
    private static final int MAP_ZEN_RAZV_RL03 = 455;
    private static final int MAP_ZEPP_01 = 462;
    private static final int MAP_ZEPP_02 = 469;
    private static final int MAP_ZEPP_03 = 476;
    private static final int MAP_ZEPP_04 = 483;
    //#+

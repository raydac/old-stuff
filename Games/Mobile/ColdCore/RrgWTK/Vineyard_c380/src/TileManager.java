...
//#local STILEM55 = false
// (VENDOR=="SIEMENS" && (MODEL=="M55" || MODEL=="S55"))
//#local HARDWARE=false
// (MIDP=="2.0" || STILEM55) && !(CYCLED || SEPARATEDIMAGES)
...
public class TileManager
{
    ...
    //#endif
    {
        ...
        //#if (VENDOR=="NOKIA" && MODEL=="7650") || (VENDOR=="SIEMENS" && MODEL=="CX65") || VENDOR=="LG" || VENDOR=="SAMSUNG"
            //#local PARTASBUFFER = true
            i_hiddenPartBufferWidth = i_hiddenBufferWidth;
            i_hiddenPartBufferHeight = i_hiddenBufferHeight;
            i_hiddenHorzPartsNumber = 1;
            i_hiddenVertPartsNumber = 1;
        //#else
            //#local PARTASBUFFER = false
    ...
    //#endif
    {
        ...
        //#if PARTASBUFFER
            p_HiddenPartBufferGraphics.drawImage(p_HBuffer,-_stepX,-_stepY,0);
            p_HBufferGraphics.drawImage(p_HiddenPartBuffer,0,0,0);
        //#else
        //$int i_initX;
        //$int i_stepX;
        //$int i_initY;

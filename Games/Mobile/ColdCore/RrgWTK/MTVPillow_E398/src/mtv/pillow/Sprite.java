...
//#endif
    ...
    public int i_ObjectSpeed;
    public int i_ObjectHitSteps;
...
//#endif
    ...
    public void readSpriteFromStream(DataInputStream _dis) throws IOException
    {
        ...
        i_ObjectSpeed = _dis.readInt();
        i_ObjectHitSteps = _dis.readInt();
     ...
     */
    public static final int DATASIZE_BYTES = 26;
    ...
    public void writeSpriteToStream(DataOutputStream _dis) throws IOException
    {
        ...
        _dis.writeInt(i_ObjectSpeed);
        _dis.writeInt(i_ObjectHitSteps);

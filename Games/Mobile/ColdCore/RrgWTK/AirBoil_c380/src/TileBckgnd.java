...
//#if (VENDOR=="SIEMENS" && MODEL=="M55") || (VENDOR=="SAMSUNG" && (MODEL=="X100" || MODEL=="C100")) || (VENDOR=="SE" && MODEL=="T610")
    //#local MAXCELLWIDTHNUMBER = 4
//#else
    //#if (VENDOR=="SIEMENS" && MODEL=="C65") || (VENDOR=="NOKIA" && (MODEL=="3510" || MODEL=="6100"))
        //#local MAXCELLWIDTHNUMBER = 8
    //#else
...
//#if VENDOR=="MOTOROLA" || VENDOR=="LG" || VENDOR=="SAMSUNG" || VENDOR=="SE" || VENDOR=="NOKIA"
    //#local CLIPCOMPENSATION=false
//#else
    //#if VENDOR=="SIEMENS" && (MODEL=="M50" || MODEL=="M55" || MODEL=="S55")
        //#local CLIPCOMPENSATION=false
    //#else
...
//#if (VENDOR=="SIEMENS" && (MODEL=="CX65" || MODEL=="C65")) || (VENDOR=="LG" && MODEL=="G1600") ||VENDOR=="SAMSUNG" || (VENDOR=="NOKIA" && (MODEL=="7650" || MODEL=="3410" || MODEL=="3510")) || (STILEM50 || STILEM55) || (VENDOR=="SE" && MODEL=="T610")
        ...
        if (_stepX != 0)
        {
            ...
            while (i_cellNumber != 0)
            {
                ...
                for (int ly = i_startYCellBlock; ly <= i_limitY; ly++)
                {
                    ...
                    //#if CLIPCOMPENSATION
                    //$int i_clX = i_pixelX<0 ? 0 : i_pixelX;
                    //$int i_clY = i_pixelY<0 ? 0 : i_pixelY;
                    //$p_hbg.setClip(i_clX, i_clY, i_blockW, i_blockH);
                    //#else
    ...
    //#endif
    {
        ...
        for (int ly = i_cellTopY; ly <= i_limitY; ly++)
        {
            ...
            for (int lx = i_startXCellBlock; lx <= i_limitX; lx++)
            {
                ...
                //$int i_clX = i_pixelX<0 ? 0 : i_pixelX;
                //$int i_clY = i_pixelY<0 ? 0 : i_pixelY;
                //$_g.setClip(i_clX, i_clY, i_blockW, i_blockH);
                //#else

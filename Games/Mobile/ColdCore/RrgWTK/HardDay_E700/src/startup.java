...
p_imageForOutput = getImage(2);
    ...
    private void gamePlayDrawing(Graphics _graphics)
    {
        ...
        if(courier != null)
        {
         ...
         {
          timer.drawDigits(_graphics, (GAMESCREEN_WIDTH - timer.fontWidth >> 1)+1, 20 , timer.i_origRadix -1 - timer.i_origRadix * p_Gamelet.i_DeliveryTimer  / p_Gamelet.i_InitDeliveryTimer);
         }
...
if (lg_FinishImagePictured)
    ...
    public Object processGameAction(int _arg1, int _arg2, Object _obj1)
    {
     ...
     int last_score = -1;
       ...
       final static int score_x = 89;
       final static int score_y = 144;

       final static int lives_x = 5;
       final static int lives_y = 6;

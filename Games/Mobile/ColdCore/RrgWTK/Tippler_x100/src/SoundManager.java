...
public class SoundManager
{
    ...
    public static final int SOUND_PLMOVE = 3;
    public static final int SOUND_PLATAKE = 4;
    public static final int SOUND_OPPMOVE = 5;
    public static final int SOUND_OPPTAKE = 6;

  ...
  */
    ...
    private class Consumer
    {
        ...
        public Consumer() throws IOException
        {
            ...
            ImagePacker.p_mtracker.addImage(p_image, 0);

            try
            {
                ImagePacker.p_mtracker.waitForAll();
            }
            ...
            ImagePacker.p_mtracker.removeImage(p_image);
    ...
    private static class ImmutableByteArray
    {
        ...
        // getBytes()
        //
        // Purpose: Get a *copy* of the bytes contained in this object.
        //

...
public class PackerTools
{
    protected static MediaTracker p_mtracker = new MediaTracker(new Button());
    private static String s_descriptorname = "index.lst";
    private static boolean lg_verbose = false;

    private static void packingPNGtoLitePNG(byte[] _inarray, DataOutputStream _outputstream) throws IOException
    {
    ...
    private static void packingForNokia(byte[] _inarray, DataOutputStream _outputstream) throws IOException
    {
    ...
    private static void packWaveletImage(byte[] _imagearray, int _packlevel, DataOutputStream _out) throws IOException
    {
    ...
    private static byte[] repackGifToPNG(byte[] _gifarray, int _packlevel, boolean _alphachannel, Palette _palette, boolean _removepalette)
    {
...
//                    System.out.println("WARNING: Color 0x"+Integer.toHexString(i_rgb)+" will be changed to 0x"+Integer.toHexString(p_equcolor.intValue()));
    ...
    private static void packingForSiemens(byte[] _inarray, DataOutputStream _outputstream) throws IOException
    {
        Image p_img = Toolkit.getDefaultToolkit().createImage(_inarray);

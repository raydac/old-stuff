...
public class SpriteCollection
{
    ...
    private final void _moveInactiveSpriteToActiveList(int _spriteOffset)
    {
        ...
        else
        {
            ...
            int i_listData = ai_dynSpriteArray[i_lastinSpriteOffset
                    + OFFSET_LISTDATA];
            ...
            i_listData = (i_lastinSpriteOffset << SHR_LISTPREVINDEX)
                    | (0xFFFF << SHR_LISTNEXTINDEX);
    ...
    private final void _moveActiveSpriteToInactiveList(int _spriteOffset)
    {
        ...
        ai_dynSpriteArray[_spriteOffset + OFFSET_ANIMATIONDATA] &= ~(MASK_ACTIVE
                | MASK_PAUSED | MASK_BACKANIMATION);
    }
    ...
    {
        int i_sprAnim = ai_spriteDataArray[_spriteOffset
           + OFFSET_ANIMATIONDATA];
     ...
     */
    public final int getFrameInfo(int _spriteOffset)
    {
        final int[] ai_spriteData = ai_spriteDataArray;
        final short[] ash_spriteAnimationData = ash_spriteAnimationDataArray;
    ...
    public final void cloneActive(int _srcSpriteOffset,int _dstSpriteOffset)
    {
        ...
        System.arraycopy(ai_spriteDataArray, _srcSpriteOffset,
                ai_spriteDataArray, _dstSpriteOffset, SPRITEDATA_LENGTH);
    }
     ...
     */
    public final void alignToArea(int _spriteOffset,int _i8x1,int _i8y1,int _i8x2,int _i8y2,boolean _screenCoords)
    {
        final int[] ai_sda = ai_spriteDataArray;
        final short[] ash_ssda = ash_spriteAnimationDataArray;

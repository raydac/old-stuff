...
public class Utils
{
    ...
    public static final String RESOURCEPATH = "ru/coldcore/gameapi/";
    private static final MediaTracker p_mediaTracker = new MediaTracker(new Button());
    ...
    public static final Image loadImageFromResource(String _resourceName) throws Throwable
    {
        ...
        Image p_result = Toolkit.getDefaultToolkit().createImage(ClassLoader.getSystemResource(_resourceName));
        ...
        if (p_result.getWidth(null) < 0 || p_result.getHeight(null) < 0) p_result = null;
    ...
    {
        java.awt.image.BufferedImage p_image = new java.awt.image.BufferedImage(_width, _height, java.awt.image.BufferedImage.TYPE_INT_ARGB);
        return p_image;
    }

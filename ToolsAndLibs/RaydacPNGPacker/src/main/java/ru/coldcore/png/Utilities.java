...
import ru.coldcore.TGA.TGAImageReader;
...
{
    protected static final TGAImageReader pTgaReader = new TGAImageReader();
    ...
    public static final BufferedImage convertFileToImage(byte [] _imageFile) throws IOException
    {
        ...
        {
            throw new IOException("Unsupported image format, you must use ether GIF,JPEG,PNG or TGA format");
        }
    ...
    {
        return new ImageIcon(ClassLoader.getSystemResource("ru/coldcore/png/images/" +_path));
    }

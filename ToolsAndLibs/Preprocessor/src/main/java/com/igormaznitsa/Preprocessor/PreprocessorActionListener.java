 ...
 * @version 1.00
 */
public interface PreprocessorActionListener
{
    /**
     ...
     * @throws IOException
     */
    public boolean processAction(Value [] _actionParameters,String _outDir,String _outName,PrintStream _mainOutputStream,PrintStream _prefixOutputStream,PrintStream _postfixOutputStream,PrintStream _infoStream) throws IOException;

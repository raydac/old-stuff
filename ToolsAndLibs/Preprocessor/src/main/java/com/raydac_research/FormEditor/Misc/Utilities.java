...
public class Utilities
{
    ...
    public static File selectDirectoryForOpen(Component _parent, String _title, File _initFile)
    {
        JFileChooser chooser = new JFileChooser();
        chooser.setMultiSelectionEnabled(false);
        chooser.setDragEnabled(false);
    ...
    {
        return new ImageIcon(ClassLoader.getSystemResource("com/igormaznitsa/j2me_wtk/images/"+_path));
    }

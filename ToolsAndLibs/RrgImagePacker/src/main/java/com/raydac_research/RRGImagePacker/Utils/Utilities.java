...
{
    public static final WaitDialog WAIT_DIALOG = new WaitDialog();

    public static byte [] compressArray(byte [] _array) throws IOException
    {
        ByteArrayOutputStream p_baos = new ByteArrayOutputStream(_array.length);
        DeflaterOutputStream p_out = new DeflaterOutputStream(p_baos);
        p_out.write(_array);
        p_out.finish();
        p_out.close();
    ...
    public static byte [] decompressArray(byte [] _packedData,int _length) throws Exception
    {
        Inflater p_out = new Inflater();
        p_out.setInput(_packedData);
        byte [] ab_data = new byte[_length];
        p_out.inflate(ab_data);
        return ab_data;
    }
    ...
    public static File selectDirectoryForSave(Component _parent, FileFilter _fileFilter, String _title, File _initFile)
    {
        JFileChooser chooser = new JFileChooser();
        chooser.setMultiSelectionEnabled(false);
        chooser.setDragEnabled(false);
    ...
    public static File selectDirectoryForOpen(Component _parent, FileFilter _fileFilter, String _title, File _initFile)
    {
        JFileChooser chooser = new JFileChooser();
        chooser.setMultiSelectionEnabled(false);
        chooser.setDragEnabled(false);
    ...
    public static File selectFilesForOpen(Component _parent, FileFilter _fileFilter, String _title, File _initFile)
    {
        JFileChooser chooser = new JFileChooser();
        chooser.setMultiSelectionEnabled(false);
        chooser.setDragEnabled(false);

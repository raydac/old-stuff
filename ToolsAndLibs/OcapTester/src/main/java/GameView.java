...
//		System.out.println("p_DrawOptimizer = "+p_DrawOptimizer.i_StackPointer);
	...
	public static final void clearBackground() throws Throwable
	{
		...
		final int [] ai_tilearray = gamefieldtiles;
		...
		for(int ly=0;ly<10;ly++)
		{
			...
			{
				final int i_imgoffset = ai_tilearray[i_arrayoffset++];
				ImageManager.drawImage(i_imgoffset,i_x,i_y);
				i_x += CELLWIDTH;
			}
			i_y += CELLHEIGHT;
		}
	...
	public static final void paint(Graphics _g) throws Throwable
	{
		...
		switch(p_clipBounds.x)
        {
            case 0:
            {
                ...
                // поле
                _g.drawImage(p_BackBuffer,82,82,null);
            };break;
	...
	private static final int MAP_BLOCK_BLUE02 = 84;
	private static final int MAP_BLOCK_BLUE03 = 91;
	private static final int MAP_BLOCK_BLUE_HEAVY01 = 98;
	private static final int MAP_BLOCK_BLUE_HEAVY02 = 105;
	private static final int MAP_BLOCK_BLUE_HEAVY03 = 112;
	private static final int MAP_BLOCK_BOMB = 119;
	private static final int MAP_BLOCK_IRON = 126;
	private static final int MAP_BLOCK_MAGNA01 = 133;
	private static final int MAP_BLOCK_MAGNA02 = 140;
	private static final int MAP_BLOCK_MAGNA03 = 147;
	private static final int MAP_BLOCK_MIRROR = 154;
	private static final int MAP_BLOCK_SAND = 161;
	private static final int MAP_BLOCK_YELLOW01 = 168;
	private static final int MAP_BLOCK_YELLOW02 = 175;
	private static final int MAP_BLOCK_YELLOW03 = 182;
	private static final int MAP_BLOCK_YELLOW_HEAVY01 = 189;
	private static final int MAP_BLOCK_YELLOW_HEAVY02 = 196;
	private static final int MAP_BLOCK_YELLOW_HEAVY03 = 203;
	private static final int MAP_BONUS_BACKGROUND01 = 210;
	private static final int MAP_BONUS_BACKGROUND02 = 217;
	private static final int MAP_BONUS_BACKGROUND03 = 224;
	private static final int MAP_BONUS_BALLS = 231;
	private static final int MAP_BONUS_BIG_BALL = 238;
	private static final int MAP_BONUS_BIG_PLATFORM = 245;
	private static final int MAP_BONUS_DEATH = 252;
	private static final int MAP_BONUS_GEN = 259;
	private static final int MAP_BONUS_LIFE = 266;
	private static final int MAP_BONUS_MAGNET = 273;
	private static final int MAP_BONUS_MIRROR = 280;
	private static final int MAP_BONUS_NEXT_LEVEL = 287;
	private static final int MAP_BONUS_NORMAL_BALL = 294;
	private static final int MAP_BONUS_POINTS = 301;
	private static final int MAP_BONUS_QUICK_BALL = 308;
	private static final int MAP_BONUS_SLOW_BALL = 315;
	private static final int MAP_BONUS_SMALL_BALL = 322;
	private static final int MAP_BONUS_SMALL_PLATFORM = 329;
	private static final int MAP_DIGIT0 = 336;
	private static final int MAP_DIGIT1 = 343;
	private static final int MAP_DIGIT2 = 350;
	private static final int MAP_DIGIT3 = 357;
	private static final int MAP_DIGIT4 = 364;
	private static final int MAP_DIGIT5 = 371;
	private static final int MAP_DIGIT6 = 378;
	private static final int MAP_DIGIT7 = 385;
	private static final int MAP_DIGIT8 = 392;
	private static final int MAP_DIGIT9 = 399;
	private static final int MAP_DIGITX = 406;
	private static final int MAP_EXPLOSION1_01 = 413;
	private static final int MAP_EXPLOSION1_02 = 420;
	private static final int MAP_EXPLOSION1_03 = 427;
	private static final int MAP_EXPLOSION1_04 = 434;
	private static final int MAP_EXPLOSION1_05 = 441;
	private static final int MAP_EXPLOSION1_06 = 448;
	private static final int MAP_EXPLOSION1_07 = 455;
	private static final int MAP_EXPLOSION1_08 = 462;
	private static final int MAP_EXPLOSION2_01 = 469;
	private static final int MAP_EXPLOSION2_02 = 476;
	private static final int MAP_EXPLOSION2_03 = 483;
	private static final int MAP_EXPLOSION2_04 = 490;
	private static final int MAP_EXPLOSION2_05 = 497;
	private static final int MAP_EXPLOSION2_06 = 504;
	private static final int MAP_EXPLOSION3_01 = 511;
	private static final int MAP_EXPLOSION3_02 = 518;
	private static final int MAP_EXPLOSION3_03 = 525;
	private static final int MAP_EXPLOSION3_04 = 532;
	private static final int MAP_EXPLOSION3_05 = 539;
	private static final int MAP_EXPLOSION3_06 = 546;
	private static final int MAP_EXPLOSION3_07 = 553;
	private static final int MAP_EXPLOSION3_08 = 560;
	private static final int MAP_FIELD01 = 567;
	private static final int MAP_FIELD02 = 574;
	private static final int MAP_FIELD03 = 581;
	private static final int MAP_FIELD04 = 588;
	private static final int MAP_FIELD05 = 595;
	private static final int MAP_FIELD06 = 602;
	private static final int MAP_FIELD07 = 609;
	private static final int MAP_FIELD08 = 616;
	private static final int MAP_FIELD09 = 623;
	private static final int MAP_FIELD10 = 630;
	private static final int MAP_FIELD11 = 637;
	private static final int MAP_FIELD12 = 644;
	private static final int MAP_FIELD13 = 651;
	private static final int MAP_FIELD14 = 658;
	private static final int MAP_FIELD15 = 665;
	private static final int MAP_FIELD16 = 672;
	private static final int MAP_FIELD17 = 679;
	private static final int MAP_FIELD18 = 686;
	private static final int MAP_FIELD19 = 693;
	private static final int MAP_FIELD20 = 700;
	private static final int MAP_FIELD21 = 707;
	private static final int MAP_FIELD22 = 714;
	private static final int MAP_FIELD23 = 721;
	private static final int MAP_FIELD24 = 728;
	private static final int MAP_LEVEL = 735;
	private static final int MAP_LIFE_ICO = 742;
	private static final int MAP_SHIELD_BIG = 749;
	private static final int MAP_SHIELD_NORMAL = 756;
	private static final int MAP_SHIELD_SMALL = 763;
	private static final int MAP_TELE_IN = 770;
	private static final int MAP_TELE_OUT = 777;
	private static final int MAP_WAGON01 = 784;
	private static final int MAP_WAGON02 = 791;
	private static final int MAP_WAGON03 = 798;
	private static final int MAP_WAGON04 = 805;


	private static final int [] gamefieldtiles = {
		MAP_FIELD01+7*18, MAP_FIELD01+7*19, MAP_FIELD01+7*20, MAP_FIELD01+7*4, MAP_FIELD01+7*5, MAP_FIELD01+7*0, MAP_FIELD01+7*14, MAP_FIELD01+7*15, MAP_FIELD01+7*3, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*1,
		MAP_FIELD01+7*21, MAP_FIELD01+7*22, MAP_FIELD01+7*23, MAP_FIELD01+7*0, MAP_FIELD01+7*2, MAP_FIELD01+7*0, MAP_FIELD01+7*16, MAP_FIELD01+7*17, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*10, MAP_FIELD01+7*11,
		MAP_FIELD01+7*3, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*10, MAP_FIELD01+7*11, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*12, MAP_FIELD01+7*13,
		MAP_FIELD01+7*6, MAP_FIELD01+7*7, MAP_FIELD01+7*0, MAP_FIELD01+7*12, MAP_FIELD01+7*13, MAP_FIELD01+7*3, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*4, MAP_FIELD01+7*5, MAP_FIELD01+7*0, MAP_FIELD01+7*0,
		MAP_FIELD01+7*8, MAP_FIELD01+7*9, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*6, MAP_FIELD01+7*7, MAP_FIELD01+7*2, MAP_FIELD01+7*0, MAP_FIELD01+7*0,
		MAP_FIELD01+7*0, MAP_FIELD01+7*4, MAP_FIELD01+7*5, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*1, MAP_FIELD01+7*0, MAP_FIELD01+7*8, MAP_FIELD01+7*9, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0,
		MAP_FIELD01+7*1, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*2, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*4, MAP_FIELD01+7*5, MAP_FIELD01+7*0, MAP_FIELD01+7*18, MAP_FIELD01+7*19, MAP_FIELD01+7*20,
		MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*21, MAP_FIELD01+7*22, MAP_FIELD01+7*23,
		MAP_FIELD01+7*14, MAP_FIELD01+7*15, MAP_FIELD01+7*3, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*10, MAP_FIELD01+7*11, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*6, MAP_FIELD01+7*7,
		MAP_FIELD01+7*16, MAP_FIELD01+7*17, MAP_FIELD01+7*0, MAP_FIELD01+7*0, MAP_FIELD01+7*2, MAP_FIELD01+7*12, MAP_FIELD01+7*13, MAP_FIELD01+7*0, MAP_FIELD01+7*3, MAP_FIELD01+7*0, MAP_FIELD01+7*8, MAP_FIELD01+7*9
		};

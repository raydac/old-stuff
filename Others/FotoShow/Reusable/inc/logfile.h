...
/*!
  ...
  */
	...
	void Log(RCall::TStatus aStatus);
...
/**
	Printing current time into te file
*/
	void PrintCurrentTime();
/**
	Get string representation errror codes
*/
	static void GetErrorCode(TInt aErrCode,TDes& aString);
/**
	Print error code as string 
*/	
	void ShowErrorCode(TInt aErrCode);

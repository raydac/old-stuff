...
public class R_HTTPClientThread extends Thread 
{
    ...
    BufferedOutputStream output_stream=null;  // Поток посылки данных клиенту
    ...
    public void send_vector(BufferedOutputStream doss,Vector vctr) throws IOException
        {
                int li;
				int loi=vctr.size();
				for (li=0;li<loi;li++)
                {
						if (vctr.elementAt(li)==null) break; else
						if (vctr.elementAt(li) instanceof String)
						{
        ...
        synchronized static public Vector err_message(int msg,String astr,String server_version)
        {
				...
				switch (msg) 
                {
						...
						case 403 : tmp_vector.addElement("HTTP/1.0 403 Forbidden resource\r\n\r\n<html><head><title>Forbidden resource</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\"></head><p><font size=\"5\"><strong>HTTP/1.0 403 Forbidden resource</strong></font></p><p>Resource: "+astr+"</p><hr><b><i>"+server_version+"</i></b></body></html>");break;
                        case 404 : tmp_vector.addElement("HTTP/1.0 404 Resource not found\r\n\r\n<html><head><title>Resource not found</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\"></head><p><font size=\"5\"><strong>HTTP/1.0 404 Resource not found</strong></font></p><p>Resource: "+astr+"</p><hr><b><i>"+server_version+"</i></b></body></html>");break;
                        case 405 : tmp_vector.addElement("HTTP/1.0 405 Method not allow\r\n\r\n<html><head><title>Method not allow</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\"></head><p><font size=\"5\"><strong>HTTP/1.0 405 Method not allow</strong></font></p><p>Resource: "+astr+"</p><hr><b><i>"+server_version+"</i></b></body></html>");break;
                        ...
                        case 500 : tmp_vector.addElement("HTTP/1.0 500 Internal server error\r\n\r\n<html><head><title>Internal server error</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\"></head><p><font size=\"5\"><strong>HTTP/1.0 500 Internal server error</strong></font></p><p>Resource: "+astr+"</p><hr><b><i>"+server_version+"</i></b></body></html>");break;
        ...
        public void run()
        {
                ...
                try
                {
                        ...
                        output_stream = new BufferedOutputStream(client_socket.getOutputStream());
							...
							catch (Exception e) 
							{
                                ...
                                {        
										...
										if ((qrec.IMS_Date!=null) && (qrec.Method.compareTo("HEAD")!=0))
										{
											...
											{ 
												if (no_closed) throw new Exception("Error during dispatch the answer");
										...
										if (fl_t)
                                        {
                                           ...
                                           {   
												  ...
												  catch (Exception er) { throw new Exception("Error during dispatch the answer");};
                                           } 
                                        }    
                                }
								bin_response = null;

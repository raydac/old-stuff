...
public class NFDServerMain {
  ...
  public static void main(String[] args) {
    ...
    if (serpar.home_dir == null) {
      serpar.home_dir = server_dir;
    }
    serpar.default_page = inifile.getProperty("DEFAULT_PAGE");
    if (serpar.default_page == null) {
      serpar.default_page = "index.htm";
    }
    ...
    try {
      ...
      while (true) {
        ...
        if (kbd_string.equalsIgnoreCase("homedir")) {
          ...
          v_f = null;
        } else if (kbd_string.equalsIgnoreCase("defaultpage")) {
          MainServer.trace_client = false;
          ...
          v_f = null;
        } else if (kbd_string.equalsIgnoreCase("close")) {
          ...
          return;
        } else if (kbd_string.equalsIgnoreCase("port")) {
          MainServer.trace_client = false;
        ...
        } else if (kbd_string.equalsIgnoreCase("maxclients")) {
          MainServer.trace_client = false;
          ...
          try {
            ...
            if ((serpar.max_client_con.intValue() > 65535) || (serpar.max_client_con.intValue() < 0))
              throw new Exception();
            MainServer.max_client_count = serpar.max_client_con.intValue();
            try {
              save_ini_file(serpar, server_dir + File.separatorChar + "server.ini");
        ...
        } else if (kbd_string.equalsIgnoreCase("about")) {
          about();
        } else if (kbd_string.equalsIgnoreCase("traceon")) {
          MainServer.trace_client = true;
        } else if (kbd_string.equalsIgnoreCase("traceoff")) {
          MainServer.trace_client = false;
        } else if (kbd_string.equalsIgnoreCase("help")) {
          help();
        } else if (kbd_string.equalsIgnoreCase("mem")) {

  ...
  public HTTPQueryRecord(Vector qr) throws Exception {
      ...
      if ((buf_string.equalsIgnoreCase("http://")) || (buf_string.equalsIgnoreCase("http:\\"))) {
        ...
        if (li >= 0) {
          ...
          if (buf_string.length() == 0) {
            buf_string = String.valueOf(File.separatorChar);
          }
        }
      }
    }
    ...
    for (li = 1; li < qr.size(); li++) {
      ...
      if (lpos >= 0) {
        ...
        } else if (left_part.compareTo("CONTENT-LENGTH") == 0) {
          Content_Length = (Integer.valueOf(right_part)).intValue();
        } else if (left_part.compareTo("CONTENT-TYPE") == 0) {
          Content_Type = right_part;
        } else if (left_part.compareTo("ACCEPT") == 0) {
          Accept = right_part;
        } else if (left_part.compareTo("PRAGMA") == 0) {
          Pragma = right_part;
        } else if (left_part.compareTo("AUTHORIZATION") == 0) {
        ...
        } else if (left_part.compareTo("FROM") == 0) {
          From = right_part;
        } else if (left_part.compareTo("IF-MODIFIED-SINCE") == 0) {
          try {
        ...
        } else if (left_part.compareTo("REFERER") == 0) {
          Referer = right_part;
        } else if (left_part.compareTo("USER-AGENT") == 0) {

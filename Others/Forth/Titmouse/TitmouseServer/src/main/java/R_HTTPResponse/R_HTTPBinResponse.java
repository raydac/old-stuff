...
public class R_HTTPBinResponse
{
        ...
        public Vector GetResponseHeader(String client_ip_address) throws Exception
        {
                ...
                if (typ_file.compareTo("HTML")==0)vector_body.addElement("Content-type: text/html\r\n");
                else
                if (typ_file.compareTo("HTM")==0) vector_body.addElement("Content-type: text/html\r\n");
                else
                if (typ_file.compareTo("GIF")==0) vector_body.addElement("Content-type: image/gif\r\n");
                else
                if (typ_file.compareTo("JPG")==0) vector_body.addElement("Content-type: image/jpg\r\n");
                else
                if (typ_file.compareTo("BMP")==0) vector_body.addElement("Content-type: image/bmp\r\n");
                else
                if (typ_file.compareTo("TIF")==0) vector_body.addElement("Content-type: image/tif\r\n");
                else
                {

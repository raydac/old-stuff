import R_HTTPResponse.HTTPQueryRecord;
import R_HTTPResponse.R_HTTPBinResponse;
  ...
  static public Vector err_message(int msg) {
    ...
    switch (msg) {
      ...
      case 402:
        ...
        break;
      case 403:
        tmp_vector.addElement("HTTP/1.0 403 Forbidden\r\n\r\n");
        break;
      case 404: {
  ...
  public void run() {
    ...
    try {
      ...
      try {
        ...
        if (trace_connect)
          System.out.println("Client " + client_socket.getInetAddress() + " requested resource " + qrec.URLString);
      } catch (Exception e) {
